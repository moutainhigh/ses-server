...
@ApiModel(value = "com-redescooter-ses-web-ros-dm-OpeContactUs")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "ope_contact_us")
public class OpeContactUs implements Serializable {
    /**
     * 主键
     */
    ...
    public static OpeContactUsBuilder builder() {
        return new OpeContactUsBuilder();
    }
}
