...
// public Response<SellsyClientResult> queryClientById(@ModelAttribute @ApiParam("请求参数") SellsyQueryClientOneEnter
// enter) {
...
// public Response<List<SellsyClientResult>> queryClientList(@ModelAttribute @ApiParam("请求参数") PageEnter enter) {
...
// public Response<PageResult<SellsyDocumentListResult>> queryDocumentList(@ModelAttribute @ApiParam("请求参数")
// SellsyDocumentListEnter enter) {
