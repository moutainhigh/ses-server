 ...
 * 发货单组装件产品概览表
 */
@ApiModel(value = "com-redescooter-ses-web-ros-dm-OpeInvoiceCombinB")
@Data
@TableName(value = "ope_invoice_combin_b")
public class OpeInvoiceCombinB implements Serializable {
    /**
     * 主键id
     */
