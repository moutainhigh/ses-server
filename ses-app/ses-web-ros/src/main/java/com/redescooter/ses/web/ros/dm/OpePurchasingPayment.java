...
@ApiModel(value = "com-redescooter-ses-web-ros-dm-OpePurchasingPayment")
@Data
@TableName(value = "ope_purchasing_payment")
public class OpePurchasingPayment implements Serializable {
    /**
     * ID
     */
