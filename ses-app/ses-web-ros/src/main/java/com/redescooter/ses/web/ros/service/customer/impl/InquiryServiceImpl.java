...
//      mailTask.setEvent(MailTemplateEventEnums.ROS_DISTRUST_LEAD_SEND_MAIL.getEvent());
        ...
        //查询区域负责人信息
        List<OpeDistrustLead> list = opeDistrustLeadService.list(new QueryWrapper<OpeDistrustLead>().eq(OpeDistrustLead.COL_DISTRUST_NAME, enter.getTimeZone()).eq(OpeDistrustLead.COL_CITY_NAME,
                enter.getTimeZone()));
