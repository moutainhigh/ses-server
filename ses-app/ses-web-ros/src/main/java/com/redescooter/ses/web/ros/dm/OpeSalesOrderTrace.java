...
@ApiModel(value = "com-redescooter-ses-web-ros-dm-OpeSalesOrderTrace")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "ope_sales_order_trace")
public class OpeSalesOrderTrace implements Serializable {
    /**
     * 主键
     */
