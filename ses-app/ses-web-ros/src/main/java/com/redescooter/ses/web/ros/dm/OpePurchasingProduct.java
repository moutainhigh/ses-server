...
@ApiModel(value = "com-redescooter-ses-web-ros-dm-OpePurchasingProduct")
@Data
@TableName(value = "ope_purchasing_product")
public class OpePurchasingProduct implements Serializable {
    /**
     * 主键
     */
     ...
     * 采购订单id
     */
    @TableField(value = "purchasing_id")
    ...
    public static final String COL_PURCHASING_ID = "purchasing_id";
