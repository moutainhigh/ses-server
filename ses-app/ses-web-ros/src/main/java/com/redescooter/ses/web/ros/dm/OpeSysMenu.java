...
public class OpeSysMenu implements Serializable {
    ...
    public static com.redescooter.ses.web.ros.dm.OpeSysMenu.OpeSysMenuBuilder builder() {
        return new com.redescooter.ses.web.ros.dm.OpeSysMenu.OpeSysMenuBuilder();
    }
}