...
@Builder
public class SellsyPackagingResult {
    private String id;
    ...
    private List<SellsyPackaginPriceResult> prices;
    ...
    private String sellCodeId;

    private String sellCodeAnalytics;

    private String purchaseCodeId;

    private String sellCode;

    private String sellCodeLabel;

    private String purchaseCode;

    private String purchaseCodeLabel;
