...
@ApiModel(value = "经销商列表出参", description = "经销商列表出参")
public class DistributorListResult extends GeneralResult implements Serializable {

    private static final long serialVersionUID = 1562676035390703312L;
