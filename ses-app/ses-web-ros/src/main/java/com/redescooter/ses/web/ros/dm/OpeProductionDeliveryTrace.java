...
@ApiModel(value = "com-redescooter-ses-web-ros-dm-OpeProductionDeliveryTrace")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "ope_production_delivery_trace")
public class OpeProductionDeliveryTrace implements Serializable {
    /**
     * 主键
     */
