...
@ApiModel(value = "经销商修改入参", description = "经销商修改入参")
public class DistributorUpdateEnter extends GeneralEnter implements Serializable {

    private static final long serialVersionUID = -5756896754681347929L;
