...
public class OpeSysRoleSalesCidy implements Serializable {
    ...
    public static com.redescooter.ses.web.ros.dm.OpeSysRoleSalesCidy.OpeSysRoleSalesCidyBuilder builder() {
        return new com.redescooter.ses.web.ros.dm.OpeSysRoleSalesCidy.OpeSysRoleSalesCidyBuilder();
    }
}