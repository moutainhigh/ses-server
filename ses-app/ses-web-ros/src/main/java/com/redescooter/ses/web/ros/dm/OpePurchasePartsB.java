 ...
 * 部件采购单产品表
 */
@ApiModel(value = "com-redescooter-ses-web-ros-dm-OpePurchasePartsB")
@Data
@TableName(value = "ope_purchase_parts_b")
public class OpePurchasePartsB implements Serializable {
    /**
     * 主键id
     */
