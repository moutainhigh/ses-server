...
//    @NotNull(code = ValidationExceptionCode.LAT_IS_EMPTY, message = "纬度为空")
    ...
    @Regexp(value = RegexpConstant.number,code = ValidationExceptionCode.BUSINESS_LICENSE_NUM_illegal_CHARACTER,message = "营业执照存在非法字符")
    ...
    @Regexp(value = RegexpConstant.number,code = ValidationExceptionCode.INVOICENUM_ILLEGAL_CHARACTER,message = "发票号存在非法字符")
