...
import com.redescooter.ses.web.ros.service.InquiryService;
...
public class InquiryServiceImpl implements InquiryService {
    ...
    public PageResult<InquiryResult> inquiryList(InquiryListEnter enter) {
        ...
        inquiryResultList.forEach(item -> {
            ...
            item.setCityName(city == null ? null : city);
            item.setDistrustName(distrust == null ? null : distrust);
        });
    ...
    public InquiryResult inquiryDetail(IdEnter enter) {
        ...
        inquiryResult.setCityName(city == null ? null : city);
        inquiryResult.setDistrustName(distrust == null ? null : distrust);
    ...
    private OpeCustomerInquiry buildOpeCustomerInquirySingle(SaveInquiryEnter enter) {
        ...
        opeCustomerInquiry.setCity(enter.getCityId() != null ? enter.getCityId() : null);
