 ...
 * 车辆采购单产品表
 */
@ApiModel(value = "com-redescooter-ses-web-ros-dm-OpePurchaseScooterB")
@Data
@TableName(value = "ope_purchase_scooter_b")
public class OpePurchaseScooterB implements Serializable {
    /**
     * 主键id
     */
