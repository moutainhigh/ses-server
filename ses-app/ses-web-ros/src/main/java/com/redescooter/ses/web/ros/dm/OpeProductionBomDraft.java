 ...
 * 整车草稿表
 */
@ApiModel(value = "com-redescooter-ses-web-ros-dm-OpeProductionBomDraft")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "ope_production_bom_draft")
public class OpeProductionBomDraft implements Serializable {
    /**
     * 主键id
     */
