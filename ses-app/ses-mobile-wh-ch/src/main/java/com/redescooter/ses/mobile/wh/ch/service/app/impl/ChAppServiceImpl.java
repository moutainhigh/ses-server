...
import com.redescooter.ses.mobile.wh.ch.enums.StatusEnum;
...
import com.redescooter.ses.mobile.wh.ch.service.app.ChAppService;
...
public class ChAppServiceImpl implements ChAppService {
    ...
    public TokenResult login(AppLoginEnter enter) {
        ...
        if (null == account) {
            throw new SesMobileChWhException(ExceptionCodeEnums.ACCOUNT_IS_NOT_EXIST.getCode(), ExceptionCodeEnums.ACCOUNT_IS_NOT_EXIST.getMessage());
        }
        ...
        if (!StringUtils.equals(encryptPassword, account.getPassword())) {
            throw new SesMobileChWhException(ExceptionCodeEnums.PASSROD_WRONG.getCode(), ExceptionCodeEnums.PASSROD_WRONG.getMessage());
        }
