...
@ApiModel(value = "com.redescooter.ses.web.delivery.dm.CorDriverScooterHistory")
@Data
@TableName(value = "cor_driver_scooter_history")
public class CorDriverScooterHistory implements Serializable {
    /**
     * ID
     */
