...
@Data
@TableName(value = "operation.ope_order_serial_bind")
public class OpeOrderSerialBind implements Serializable {
    /**
     * 主键
     */
    ...
    /**
     * 单据类型 1调拨单 2、采购单 3、发货单 4出库单 5委托单 6物流运输单 7工厂采购单 8工厂入库单 9组装单 10车辆 11组装件
     */
    @TableField(value = "order_type")
    @ApiModelProperty(value = "单据类型 1调拨单 2、采购单 3、发货单 4出库单 5委托单 6物流运输单 7工厂采购单 8工厂入库单 9组装单 10车辆 11组装件")
