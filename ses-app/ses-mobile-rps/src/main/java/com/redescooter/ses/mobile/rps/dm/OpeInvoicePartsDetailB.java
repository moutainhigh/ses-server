 ...
 * 发货单部件产品明细表
 */
@ApiModel(value = "com-redescooter-ses-mobile-rps-dm-OpeInvoicePartsDetailB")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "ope_invoice_parts_detail_b")
public class OpeInvoicePartsDetailB implements Serializable {
    /**
     * 主键id
     */
