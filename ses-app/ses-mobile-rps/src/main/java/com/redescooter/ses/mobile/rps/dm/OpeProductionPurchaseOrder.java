...
@Data
@TableName(value = "operation.ope_production_purchase_order")
public class OpeProductionPurchaseOrder implements Serializable {
    /**
     * 主键id
     */
    ...
    /**
     * 生产采购单状态 1草稿 10采购中 15已到货 20已完成
     */
    @TableField(value = "purchase_status")
    @ApiModelProperty(value = "生产采购单状态 1草稿 10采购中 15已到货 20已完成")
    ...
    private Integer factoryPrincipalId;
