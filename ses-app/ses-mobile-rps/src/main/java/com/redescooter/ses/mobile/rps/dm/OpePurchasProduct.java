...
@ApiModel(value = "com-redescooter-ses-mobile-rps-dm-OpePurchasProduct")
@Getter
@Setter
@ToString
@Builder
...
public class OpePurchasProduct implements Serializable {
    /**
     * 主键
     */
    ...
    public static OpePurchasProductBuilder builder() {
        return new OpePurchasProductBuilder();
    }
}