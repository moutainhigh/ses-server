 ...
 * 组装件采购单产品表
 */
@ApiModel(value = "com-redescooter-ses-mobile-rps-dm-OpePurchaseCombinB")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "ope_purchase_combin_b")
public class OpePurchaseCombinB implements Serializable {
    /**
     * 主键id
     */
