 ...
 * 发货单组装件产品明细表
 */
@ApiModel(value = "com-redescooter-ses-mobile-rps-dm-OpeInvoiceCombinDetailB")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "ope_invoice_combin_detail_b")
public class OpeInvoiceCombinDetailB implements Serializable {
    /**
     * 主键id
     */
