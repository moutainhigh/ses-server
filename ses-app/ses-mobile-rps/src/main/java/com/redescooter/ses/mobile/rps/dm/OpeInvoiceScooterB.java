 ...
 * 发货单车辆产品概览表
 */
@ApiModel(value = "com-redescooter-ses-mobile-rps-dm-OpeInvoiceScooterB")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "ope_invoice_scooter_b")
public class OpeInvoiceScooterB implements Serializable {
    /**
     * 主键id
     */
