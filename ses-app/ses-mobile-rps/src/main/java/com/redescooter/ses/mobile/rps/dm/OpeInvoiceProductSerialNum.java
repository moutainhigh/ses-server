 ...
 * 发货单产品序列号表
 */
@ApiModel(value = "com-redescooter-ses-mobile-rps-dm-OpeInvoiceProductSerialNum")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "ope_invoice_product_serial_num")
public class OpeInvoiceProductSerialNum {
