/*
 ...
 Source Schema         : operation_test

 Target Server Type    : MySQL
 Target Server Version : 80020
 File Encoding         : 65001

 Date: 25/06/2020 00:58:03
*/
...
CREATE TABLE `ope_allocate` (
  ...
  `dr` int DEFAULT NULL COMMENT '删除标识',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `user_id` bigint DEFAULT NULL COMMENT 'userid',
  `allocate_num` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '调拨编号',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '状态',
  `count` int DEFAULT NULL COMMENT '数量',
  `consignee_id` bigint DEFAULT NULL COMMENT '收获人Id',
  `preparation_wait_total` int DEFAULT NULL COMMENT '待备料总数',
  `pending_storage_total` int DEFAULT NULL COMMENT '待入库数量',
  ...
  `def1` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def2` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def3` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def5` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='调拨单';
...
CREATE TABLE `ope_allocate_b` (
  ...
  `user_id` bigint DEFAULT NULL COMMENT 'userId',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `allocate_id` bigint DEFAULT NULL COMMENT '调拨单Id',
  `part_id` bigint DEFAULT NULL COMMENT '部件Id',
  `materiel_product_id` bigint DEFAULT NULL COMMENT '产品物料id',
  `materiel_product_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产品物料类型',
  `total` int DEFAULT NULL COMMENT '数量',
  `preparation_wait_qty` int DEFAULT NULL COMMENT '待备料总数',
  `pending_storage_qty` int DEFAULT NULL COMMENT '待入库数量',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT '0' COMMENT '更新人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='调拨单子表';
...
CREATE TABLE `ope_allocate_b_trace` (
  ...
  `dr` int DEFAULT NULL COMMENT '删除标识',
  `allocate_id` bigint DEFAULT NULL COMMENT '调拨单Id',
  `allocate_b_id` bigint DEFAULT NULL COMMENT '调拨单子表Id',
  `part_id` bigint DEFAULT NULL COMMENT '部件Id',
  `batch_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '批次号',
  `qty` int DEFAULT NULL COMMENT '备料数量',
  `serial_num` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '序列号',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT '0' COMMENT '更新人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='调拨备料记录表';
...
CREATE TABLE `ope_allocate_trace` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT '0' COMMENT '逻辑删除标识 0正常 1删除',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `user_id` bigint DEFAULT NULL COMMENT 'userId',
  `allocate_id` bigint NOT NULL COMMENT '采购订单id',
  `status` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '采购单状态',
  `event` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '事件',
  `event_time` datetime DEFAULT NULL COMMENT '事件时间',
  `memo` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注 放话术参数',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` bigint DEFAULT NULL COMMENT '创建人',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `update_by` bigint DEFAULT NULL COMMENT '更新人',
  `def1` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def2` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def3` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def5` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='调拨单节点表';
...
CREATE TABLE `ope_assembiy_order_trace` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT '0' COMMENT '逻辑删除标识 0正常 1删除',
  `ope_assembiy_order_id` bigint DEFAULT NULL COMMENT '组装单主键',
  `user_id` bigint DEFAULT NULL COMMENT '用户id',
  `status` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '状态',
  `event` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '事件',
  `event_time` datetime DEFAULT NULL COMMENT '事件时间',
  `memo` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注说明',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='组装单节点表';
...
CREATE TABLE `ope_assembly_b_order` (
  ...
  `user_id` bigint DEFAULT NULL COMMENT '用户id',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `assembly_id` bigint DEFAULT NULL COMMENT '组装单id',
  `product_id` bigint DEFAULT NULL COMMENT '产品id',
  `assemblyb_number` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '子表编号',
  `product_number` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产品编码',
  `en_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产品英文名',
  `price` decimal(10,2) DEFAULT NULL COMMENT '产品单价',
  `wait_assembly_qty` int DEFAULT NULL COMMENT '待组装数量',
  `in_wait_wh_qty` int DEFAULT NULL COMMENT '待入库数',
  `lave_wait_qc_qty` int DEFAULT NULL COMMENT '待质检数',
  `assembly_qty` int DEFAULT NULL COMMENT '组装总数量',
  `complete_qty` int DEFAULT NULL COMMENT '完成组装数',
  `revision` int NOT NULL DEFAULT '0' COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建表',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='组装单产品明细表';
...
CREATE TABLE `ope_assembly_b_qc` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT NULL COMMENT '删除标志',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `user_id` bigint DEFAULT NULL COMMENT 'userId',
  `assembly_b_id` bigint DEFAULT NULL COMMENT '组装子表Id',
  `product_id` bigint DEFAULT NULL COMMENT '产品Id',
  `quality_inspector_id` bigint DEFAULT NULL COMMENT '质检人Id',
  `batch_no` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '质检批次号',
  `status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '质检状态',
  `total_quality_inspected` int DEFAULT NULL COMMENT '需要质检总数',
  `pass_count` int DEFAULT NULL COMMENT '质检通过数量',
  `fail_count` int DEFAULT NULL COMMENT '质检失败数量',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='采购条目QC质检';
...
CREATE TABLE `ope_assembly_lot_trace` (
  ...
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `user_id` bigint DEFAULT NULL COMMENT 'userId',
  `assembly_id` bigint DEFAULT NULL COMMENT '组装表Id',
  `quality_inspector_id` bigint DEFAULT NULL COMMENT '质检人Id',
  `batch_no` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '质检批次号',
  `total_quality_inspected` int DEFAULT NULL COMMENT '需要质检总数',
  `pass_count` int DEFAULT NULL COMMENT '质检通过数量',
...
CREATE TABLE `ope_assembly_order` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT NULL COMMENT '逻辑删除标识',
  `user_id` bigint DEFAULT NULL COMMENT '用户id',
  `tenant_id` bigint DEFAULT '0' COMMENT '租户id',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '状态',
  `assembly_number` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '组装单订单号',
  `total_qty` int DEFAULT NULL COMMENT '产品数量之和',
  ...
  `payment_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '付款类型',
  `product_price` decimal(10,2) DEFAULT NULL COMMENT '产品生产价格',
  `factory_id` bigint DEFAULT NULL COMMENT '代工厂id',
  `factory_annex` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '工厂附件',
  `consignee_id` bigint DEFAULT NULL COMMENT '收货人姓氏',
  `wait_assembly_total` int DEFAULT NULL COMMENT '待组装总数量',
  `in_wait_wh_total` int DEFAULT NULL COMMENT '待入库总数',
  `lave_wait_qc_total` int DEFAULT NULL COMMENT '待质检总数',
  `wait_preparation_total` int DEFAULT NULL COMMENT '待备料数量',
  `revision` int NOT NULL DEFAULT '0' COMMENT '乐观锁',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='组装单';
...
CREATE TABLE `ope_assembly_order_part` (
  ...
  `part_id` bigint DEFAULT NULL COMMENT '部件Id',
  `assembly_id` bigint DEFAULT NULL COMMENT '组装单Id',
  `total_qty` int DEFAULT NULL COMMENT '消耗部件数量',
  `wait_preparation_qty` int DEFAULT NULL COMMENT '待备料数量',
  `revision` int NOT NULL DEFAULT '0' COMMENT '乐观锁',
  `created_by` bigint DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `ope_assembly_order_payment` (
  ...
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `user_id` bigint DEFAULT NULL COMMENT 'userId',
  `ope_assembly_order_id` bigint DEFAULT NULL COMMENT '组装单主键',
  ...
  `payment_day` int DEFAULT NULL COMMENT '付款周期',
  `payment_time` datetime DEFAULT NULL COMMENT '实际付款时间',
  `payment_status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支付状态:Paid Unpaid',
  `payment_priority` int NOT NULL DEFAULT '0' COMMENT '支付优先级',
  ...
  `amount_proportion` int NOT NULL COMMENT '55% 标示为 55',
  `invoice_num` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票单号',
  `invoice_picture` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票附件',
  `revision` int NOT NULL DEFAULT '0' COMMENT '乐观锁',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint NOT NULL DEFAULT '0' COMMENT '更新人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='组装单付款表';
...
CREATE TABLE `ope_assembly_preparation` (
  ...
  `tenant_id` bigint DEFAULT '0' COMMENT '租户id',
  `assembly_id` bigint DEFAULT NULL COMMENT '组装单Id',
  `assembly_order_part_id` bigint DEFAULT NULL COMMENT '组装部品表Id',
  `part_id` bigint DEFAULT NULL COMMENT '部件Id',
  `serial_num` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '序列号',
  `batch_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '批次号',
  `qty` int DEFAULT NULL COMMENT '备料数量',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='组装备料记录表';
...
CREATE TABLE `ope_assembly_qc_item` (
  ...
  `dr` int DEFAULT NULL COMMENT '删除标识',
  `assembly_id` bigint DEFAULT NULL COMMENT '组装单id',
  `assembly_b_id` bigint DEFAULT NULL COMMENT '组装单子表Id',
  `assembly_b_qc_id` bigint DEFAULT NULL COMMENT '质检结果表',
  `product_id` bigint DEFAULT NULL COMMENT '产品Id',
  `assembly_lot_id` bigint DEFAULT NULL COMMENT '批次质检记录id',
  `serial_num` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '序列号',
  `batch_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '批次号',
  `qc_result` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '质检结果',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建表',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT NULL COMMENT '更新人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='组装单质检条目';
...
CREATE TABLE `ope_assembly_qc_trace` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT NULL COMMENT '删除标识',
  `ope_assembly_b_id` bigint DEFAULT NULL COMMENT '组装单子表id',
  `product_qc_template_b_id` bigint DEFAULT NULL COMMENT '质检项结果Id',
  `product_qc_template_b_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '质检结果',
  `product_qc_template_id` bigint DEFAULT NULL COMMENT '质检项Id',
  `product_qc_template_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '质检项名称',
  `assembly_qc_item_id` bigint DEFAULT NULL COMMENT '商品质检条目',
  `picture` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '质检图片（多个图片逗号分隔）',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT '0' COMMENT '更新人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='组装单质检记录';
...
CREATE TABLE `ope_customer` (
  ...
  `dr` int DEFAULT '0' COMMENT '逻辑删除标识 0正常 1删除',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `time_zone` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '时区',
  `country` bigint DEFAULT NULL COMMENT '国家',
  `country_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '国家编码，如手机号 中国 +86',
  `city` bigint DEFAULT NULL COMMENT '城市',
  `distrust` bigint DEFAULT NULL COMMENT '区域',
  `status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '状态',
  `sales_id` bigint DEFAULT NULL COMMENT '销售',
  `customer_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户编码',
  `customer_first_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户名字',
  `customer_last_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户名字',
  `customer_full_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户名字',
  `company_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '企业名称',
  `picture` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户头像',
  `customer_source` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户来源渠道 官网/email/电话',
  `customer_type` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户类型 1企业/2个人',
  `industry_type` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户行业类型，1餐厅/2快递',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '地址',
  `place_id` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '地点编号',
  `longitude` decimal(32,10) DEFAULT NULL COMMENT '经度',
  `latitude` decimal(32,10) DEFAULT NULL COMMENT '纬度',
  `contact_first_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户名字',
  `contact_last_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户名字',
  `contact_full_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '联系人全名',
  ...
  `memo` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注信息',
  `scooter_quantity` int DEFAULT NULL COMMENT '车辆数量',
  `assignation_scooter_qty` int DEFAULT NULL COMMENT '已分配车辆数',
  `certificate_type` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '证件类型1身份证，2驾驶证，3护照',
  `certificate_positive_annex` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '证件正面图片',
  `certificate_negative_annex` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '证件反面图片',
  `business_license_num` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '营业执照编号',
  `business_license_annex` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '营业执照图片',
  `invoice_num` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票编号',
  `invoice_annex` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票附件',
  `contract_annex` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '合同附件',
  `account_flag` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '账号使用标识，即激活使用过1，未激活未使用0',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '创建人',
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_by` bigint NOT NULL DEFAULT '0' COMMENT '更新人',
  `updated_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `ope_customer_accessories` (
  ...
  `product_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '产品名称',
  `product_id` bigint DEFAULT NULL COMMENT '适用于产品的产品Id',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '创建人',
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_by` bigint NOT NULL DEFAULT '0' COMMENT '更新人',
  `updated_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品配件表';
...
CREATE TABLE `ope_customer_contact` (
  `id` bigint NOT NULL COMMENT 'id',
  `dr` int DEFAULT '0' COMMENT '逻辑删除标识 0正常 1删除',
  `country_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '国家编码如+86',
  `customer_id` bigint DEFAULT NULL COMMENT '客户id',
  `name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '姓名',
  `first_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '姓名',
  `last_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '姓名',
  `telephone` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '电话',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='客户联系人表';
...
CREATE TABLE `ope_customer_inquiry` (
  ...
  `country` bigint DEFAULT NULL COMMENT '国家',
  `city` bigint DEFAULT NULL COMMENT '城市',
  `district` bigint DEFAULT NULL COMMENT '区域',
  `customer_source` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户来源渠道 官网/email/电话',
  `sales_id` bigint DEFAULT NULL COMMENT '销售员id',
  `status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '状态 已处理/未处理（默认）',
  `industry` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '行业 行业',
  `customer_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户类型 企业/个人',
  `first_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户名字',
  `last_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户名字',
  `full_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户名字',
  `company_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '公司名称',
  `country_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '国家编码如+86',
  `telephone` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '电话',
  `email` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户邮箱',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户地址',
  `contact_first` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '联系人',
  `contact_last` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `contant_full_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `product_id` bigint DEFAULT NULL COMMENT '产品Id ',
  `product_model` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '产品型号',
  `product_price` decimal(10,2) DEFAULT NULL COMMENT '产品单价',
  `total_price` decimal(10,2) DEFAULT NULL COMMENT '单据总价',
  `scooter_quantity` int DEFAULT NULL COMMENT '需求车辆数',
  `pay_status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支付状态',
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  `source` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '来源1 询价单 2预订单',
  `bank_card_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '银行卡上面名字',
  `cvv` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'cvv',
  `expired_time` date DEFAULT NULL COMMENT '过期时间',
  `card_Num` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '卡号',
  `postal_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '安全码',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '创建人',
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `updated_by` bigint NOT NULL DEFAULT '0' COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='客户咨询管理';
...
CREATE TABLE `ope_customer_inquiry_b` (
  `id` bigint NOT NULL COMMENT 'id',
  `dr` int DEFAULT '0' COMMENT '逻辑删除标识 0正常 1删除',
  `inquiry_id` bigint DEFAULT NULL COMMENT '询价单Id',
  `product_id` bigint DEFAULT NULL COMMENT '产品Id',
...
CREATE TABLE `ope_excle_import` (
  `id` bigint NOT NULL COMMENT 'ID',
  `dr` int DEFAULT NULL COMMENT '逻辑删除标识 0正常 1删除',
  ...
  `count` int NOT NULL DEFAULT '0' COMMENT '导入成功数量',
  ...
  `message` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '导入说明',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='表格导入记录表';
...
CREATE TABLE `ope_factory` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int NOT NULL DEFAULT '0' COMMENT '逻辑删除标识',
  ...
  `place_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '地址唯一ID',
  `geo_hash` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'geo_hash',
  `factory_tag` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '代工厂标签',
  `factory_memo` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '代工厂备注',
  `contact_first_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '联系人名字',
  `contact_last_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '联系人姓氏',
  `contact_full_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '联系人全名',
  ...
  `payment_cycle` int NOT NULL COMMENT '付款周期',
  ...
  `contract_number` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '合同编号',
  `contract_annex` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '合同附件',
  `overdue_flag` int NOT NULL DEFAULT '0' COMMENT '是否过期：默认0不过期，-1过期',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `created_by` bigint NOT NULL COMMENT '创建人',
  `updated_time` datetime NOT NULL COMMENT '更新时间',
  `updated_by` bigint NOT NULL COMMENT '更新人',
  `def1` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def2` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def5` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def3` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def6` double DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='代工厂';
...
CREATE TABLE `ope_factory_trace` (
  `id` bigint NOT NULL COMMENT 'ID',
  `dr` int DEFAULT '0' COMMENT '逻辑删除标识 0正常 1删除',
  `factory_id` bigint NOT NULL COMMENT '代工厂ID',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户ID',
  `user_id` bigint DEFAULT NULL COMMENT '用户ID',
  `status` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '代工厂操作状态',
  `event` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '代工厂操作事件',
  `event_time` datetime DEFAULT NULL COMMENT '事件时间',
  `reason` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注说明',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint NOT NULL DEFAULT '0' COMMENT '更新人',
  `updated_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='代工厂操作根据表';
...
CREATE TABLE `ope_part_draft_qc_template` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int NOT NULL COMMENT '逻辑删除',
  `part_draft_id` bigint DEFAULT NULL COMMENT '部件Id',
  `import_excel_batch_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '导入批次号',
  `source_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '来源方式',
  `qc_item_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '质检项名称',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint NOT NULL COMMENT '创建人',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `updated_by` bigint NOT NULL COMMENT '更新人',
  `updated_time` datetime NOT NULL COMMENT '更新时间',
  `def1` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def2` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def3` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def5` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def6` decimal(10,6) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部件质检模板';
...
CREATE TABLE `ope_part_draft_qc_template_b` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int NOT NULL COMMENT '逻辑删除',
  `part_draft_qc_template_id` bigint DEFAULT NULL COMMENT '质检项Id',
  `qc_result` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '质检结果',
  `pass_flag` tinyint(1) DEFAULT NULL COMMENT '通过标记',
  `upload_flag` tinyint(1) DEFAULT NULL COMMENT '是否允许上传图片',
  `results_sequence` int DEFAULT NULL COMMENT '结果集排序优先级',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint NOT NULL COMMENT '创建人',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `updated_by` bigint NOT NULL COMMENT '更新人',
  ...
  `def6` decimal(10,6) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部件质检模板结果项';
...
CREATE TABLE `ope_part_qc_template_b` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int NOT NULL COMMENT '逻辑删除',
  `part_qc_template_id` bigint DEFAULT NULL COMMENT '质检项Id',
  `qc_result` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '质检结果',
  `pass_flag` tinyint DEFAULT NULL COMMENT '通过标记',
  `upload_flag` tinyint(1) DEFAULT NULL COMMENT '是否允许上传图片',
  `results_sequence` int DEFAULT NULL COMMENT '结果集排序优先级',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint NOT NULL COMMENT '创建人',
...
CREATE TABLE `ope_parts` (
  ...
  `parts_draft_id` bigint NOT NULL DEFAULT '0' COMMENT '部件草稿主键',
  ...
  `cn_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '中文名称',
  `fr_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '法文名称',
  `en_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '英文名称',
  `sn_class` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '是否可销售 是否可销售,0:SC仅可采购，1:SSC可销售可采购',
  `parts_qty` int DEFAULT NULL COMMENT '部品数量',
  `production_cycle` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '生产周期',
  `cost` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '成本',
  `supplier_id` bigint DEFAULT NULL COMMENT '供应商',
  `dwg` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '图纸',
  ...
  `def6` decimal(10,6) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='物料表';
...
CREATE TABLE `ope_parts_draft` (
  ...
  `def6` decimal(10,6) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='物料草稿表';
...
CREATE TABLE `ope_parts_draft_history_record` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户ID',
  `user_id` bigint NOT NULL DEFAULT '0' COMMENT '用户ID',
  `parts_draft_id` bigint NOT NULL COMMENT '产品部品表主键',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='BOM产品部件草稿表操作记录表';
...
CREATE TABLE `ope_parts_product` (
  ...
  `sn_class` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '是否可销售,0:SC仅可采购，1:SSC可销售可采购',
  `product_type` int NOT NULL COMMENT '产品类型 如1整车，2组装套件，电池',
  `product_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产品编码',
  `product_number` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '产品编号',
  `cn_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '中文名称',
  `fr_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '法文名称',
  `en_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '英文名称',
  `production_cycle` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '生产周期',
  `sum_parts_qty` int NOT NULL COMMENT '已选部品数量',
  `model` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '型号',
  `pictures` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '图片',
  `color` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '颜色',
  ...
  `mater_parameter` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产品参数 存储JSON',
  `other_parameter` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '其他参数 存储JSON',
  `note` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint NOT NULL COMMENT '创建人',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  ...
  `def6` decimal(10,6) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部件产品表';
...
INSERT INTO `ope_parts_product` VALUES (1000001, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-50CC-01', 'RED E50', 'RED E50', 'RED E50', '30', 1, '1', NULL, '1', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:13:57', 1000003, '2020-06-14 10:13:57', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000002, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-50CC-02', 'RED E50', 'RED E50', 'RED E50', '30', 1, '1', NULL, '2', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:14:06', 1000003, '2020-06-14 10:14:06', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000003, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-50CC-03', 'RED E50', 'RED E50', 'RED E50', '30', 1, '1', NULL, '3', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:14:17', 1000003, '2020-06-14 10:14:17', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000004, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-50CC-04', 'RED E50', 'RED E50', 'RED E50', '30', 1, '1', NULL, '4', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:14:28', 1000003, '2020-06-14 10:14:28', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000005, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-50CC-05', 'RED E50', 'RED E50', 'RED E50', '30', 1, '1', NULL, '5', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:14:40', 1000003, '2020-06-14 10:14:40', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000006, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-100CC-01', 'RED E100', 'RED E100', 'RED E100', '30', 1, '2', NULL, '1', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:14:55', 1000003, '2020-06-14 10:14:55', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000007, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-100CC-02', 'RED E100', 'RED E100', 'RED E100', '30', 1, '2', NULL, '2', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:15:04', 1000003, '2020-06-14 10:15:04', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000008, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-100CC-03', 'RED E100', 'RED E100', 'RED E100', '30', 1, '2', NULL, '3', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:15:14', 1000003, '2020-06-14 10:15:14', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000009, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-100CC-04', 'RED E100', 'RED E100', 'RED E100', '30', 1, '2', NULL, '4', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:15:25', 1000003, '2020-06-14 10:15:25', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000010, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-100CC-05', 'RED E100', 'RED E100', 'RED E100', '30', 1, '2', NULL, '5', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:15:36', 1000003, '2020-06-14 10:15:36', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000011, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-125CC-01', 'RED E125', 'RED E125', 'RED E125', '10', 1, '3', NULL, '1', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:15:50', 1000003, '2020-06-14 10:15:50', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000012, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-125CC-02', 'RED E125', 'RED E125', 'RED E125', '20', 1, '3', NULL, '2', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:16:03', 1000003, '2020-06-14 10:16:03', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000013, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-125CC-03', 'RED E125', 'RED E125', 'RED E125', '30', 1, '3', NULL, '3', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:16:23', 1000003, '2020-06-14 10:16:23', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000014, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-125CC-04', 'RED E125', 'RED E125', 'RED E125', '30', 1, '3', NULL, '4', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:16:37', 1000003, '2020-06-14 10:16:37', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `ope_parts_product` VALUES (1000015, 0, 0, 1000003, '1', '2', 4, 'Scooter', 'RED-125CC-05', 'RED E125', 'RED E125', 'RED E125', '30', 1, '3', NULL, '5', 1, 0, NULL, NULL, NULL, 0, 1000003, '2020-06-14 10:16:47', 1000003, '2020-06-14 10:16:47', NULL, NULL, NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `ope_parts_product_b` (
  `id` bigint NOT NULL COMMENT '主键 主键',
  `dr` int NOT NULL COMMENT '逻辑删除 逻辑删除',
  `tenant_id` bigint NOT NULL COMMENT '租户ID 租户ID',
  ...
  `parts_id` bigint NOT NULL COMMENT '部品主键 部品主键',
  `parts_product_id` bigint NOT NULL COMMENT '部品组装表主键 部品组装表主键',
  `parts_qty` int NOT NULL COMMENT '部品数量 数量',
  `note` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注 备注',
  ...
  `def1` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段 冗余字段',
  `def2` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段 冗余字段',
  `def3` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段 冗余字段',
  `def5` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段 冗余字段',
  `def6` decimal(10,6) DEFAULT NULL COMMENT '冗余字段 冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部件产品表条目';
...
CREATE TABLE `ope_parts_sec` (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID 用户ID',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '状态 状态',
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '项目区域名称 项目区域名称',
  `code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '项目区域编码 项目区域编码',
  ...
  `def6` decimal(10,6) DEFAULT NULL COMMENT '冗余字段 冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部品项目区域表';
...
CREATE TABLE `ope_parts_type` (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '状态',
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部品类型名称',
  `code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部品类型编码',
  `value` int DEFAULT NULL COMMENT '值',
  `note` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  ...
  `def6` decimal(10,6) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部品类型表';
...
CREATE TABLE `ope_price_sheet` (
  ...
  `currency_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '货币类型 如英镑，美元，人民币',
  `currency_unit` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '货币单位 如¥，$，€，	￡',
  `standard_currency` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '标准货币 用户货币转换',
  `exchange_rate` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '汇率 用于汇率转换',
  `parts_id` bigint DEFAULT NULL COMMENT '部品主键 用于关联部品',
  ...
  `def6` decimal(10,2) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='报价列表 报价列表';
...
CREATE TABLE `ope_price_sheet_history` (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID 用户ID',
  `parts_id` bigint DEFAULT NULL COMMENT '部品主键 用于关联部品',
  `price_sheet_id` bigint DEFAULT NULL COMMENT '报价表主键 用于关联报价表',
  `price` decimal(10,2) DEFAULT NULL COMMENT '价格 浮点型价格',
  `currency_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '货币类型 如英镑，美元，人民币',
  `currency_unit` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '货币单位 如¥，$，€，	￡',
  `standard_currency` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '标准货币 用户货币转换',
  ...
  `def6` decimal(10,2) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='报价列表历史记录';
...
CREATE TABLE `ope_product_assembly` (
  ...
  `product_serial_num` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产品序列号',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='产品组装表';
...
CREATE TABLE `ope_product_assembly_b` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT NULL COMMENT '删除标识',
  `product_assembly_id` bigint DEFAULT NULL COMMENT '产品组装表Id',
  `part_id` bigint DEFAULT NULL COMMENT '部件Id',
  `qty` int DEFAULT NULL COMMENT '部件数量',
  `part_serial_num` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部件序列号',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT '0' COMMENT '更新人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='产品组装子表';
...
CREATE TABLE `ope_product_qc_template` (
  ...
  `def6` decimal(10,6) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='商品质检模板';
...
CREATE TABLE `ope_product_qc_template_b` (
  ...
  `pass_flag` tinyint(1) DEFAULT NULL COMMENT '通过标记',
  `upload_flag` tinyint(1) DEFAULT NULL COMMENT '是否允许上传图片',
  `results_sequence` int DEFAULT NULL COMMENT '质检结果集优先级',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint NOT NULL COMMENT '创建人',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `updated_by` bigint NOT NULL COMMENT '更新人',
...
CREATE TABLE `ope_purchas` (
  `id` bigint NOT NULL COMMENT '主键 主键',
  `dr` int DEFAULT NULL COMMENT '逻辑删除标识 逻辑删除标识',
  `user_id` bigint DEFAULT NULL COMMENT '租户Id',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `consignee_id` bigint DEFAULT NULL COMMENT '收货人Id',
  `contract_no` varchar(128) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '采购单编号 采购单标号',
  `status` varchar(128) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '状态 采购单状态',
  `payment_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '付款类型',
  `factory_id` bigint DEFAULT NULL COMMENT '工厂主键 代工厂Id',
  `factory_annex` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '工厂组装附件',
  `total_price` decimal(10,2) DEFAULT NULL COMMENT '总金额 总金额',
  `total_qty` int DEFAULT NULL COMMENT '总数量 总数量',
  `lave_wait_qc_total` int DEFAULT NULL COMMENT '待质检总数',
  `in_wait_wh_total` int DEFAULT NULL COMMENT '待入库总数',
  `revision` int NOT NULL DEFAULT '0' COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='采购订单';
...
CREATE TABLE `ope_purchas_b` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT NULL COMMENT '逻辑删除表示',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `user_id` bigint DEFAULT NULL COMMENT '租户Id',
  `purchas_id` bigint DEFAULT NULL COMMENT '采购订单Id',
  `part_id` bigint DEFAULT NULL COMMENT '部品Id',
  `supplier_id` bigint DEFAULT NULL COMMENT '供应商Id',
  `supplier_annex` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '供应商附件',
  `qc_status` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'qc质检状态',
  `price` decimal(10,2) DEFAULT NULL COMMENT '单价',
  `total_count` int DEFAULT NULL COMMENT '总数量',
  `total_price` decimal(10,2) DEFAULT NULL COMMENT '总价格',
  `lave_wait_qc_qty` int DEFAULT NULL COMMENT '待质检数',
  `in_wait_wh_qty` int DEFAULT NULL COMMENT '待入库数量',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT '0' COMMENT '更新人',
  `updated_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  ...
  `def5` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '冗余字段',
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='采购单条目';
...
CREATE TABLE `ope_purchas_b_qc` (
  ...
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `user_id` bigint DEFAULT NULL COMMENT 'userId',
  `purchas_b_id` bigint DEFAULT NULL COMMENT '采购单条目Id',
  `parts_id` bigint DEFAULT NULL COMMENT '部品Id',
  `quality_inspector_id` bigint DEFAULT NULL COMMENT '质检人Id',
  `batch_no` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '质检批次号',
  `status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '质检状态',
  `total_quality_inspected` int DEFAULT NULL COMMENT '需要质检总数',
...
CREATE TABLE `ope_purchas_b_qc_item` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT NULL COMMENT '删除标志',
  `purchas_b_id` bigint DEFAULT NULL COMMENT '采购单子表Id',
  `part_id` bigint DEFAULT NULL COMMENT '部品Id',
  `purchas_b_qc_id` bigint DEFAULT '0' COMMENT '质检结果Id',
  `purchas_b_lot_trace_id` bigint DEFAULT NULL COMMENT '质检批次记录Id',
  `batch_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '批次号',
  `serial_num` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部品序列号',
  `qc_batch_total` int DEFAULT NULL COMMENT '批量质检数量 和质检方式连用',
  `qc_result` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '质检结果',
  `revision` int NOT NULL DEFAULT '0' COMMENT '乐观锁',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部件质检条目';
...
CREATE TABLE `ope_purchas_lot_trace` (
  ...
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `user_id` bigint DEFAULT NULL COMMENT 'userId',
  `purchas_id` bigint DEFAULT NULL COMMENT '采购单号',
  `quality_inspector_id` bigint DEFAULT NULL COMMENT '质检人Id',
  `batch_no` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '质检批次号',
  `total_quality_inspected` int DEFAULT NULL COMMENT '需要质检总数',
  `pass_count` int DEFAULT NULL COMMENT '质检通过数量',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='采购单批次质检记录';
...
CREATE TABLE `ope_purchas_payment` (
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='销售订单支付表 分期时表明是第几期支付的';
...
CREATE TABLE `ope_purchas_product` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT NULL COMMENT '删除表示',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `user_id` bigint DEFAULT NULL COMMENT '租户Id',
  `purchas_id` bigint DEFAULT NULL COMMENT '采购订单id',
  `product_id` bigint DEFAULT NULL COMMENT '产品Id',
  `id_class` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'qc质检类型（整车质检、部品质检）',
  `product_type` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '产品类型',
  `product_num` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '产品编号',
  `revision` int NOT NULL DEFAULT '0' COMMENT '乐观锁',
  `created_by` bigint DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT NULL COMMENT '更新人',
  `updated_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='采购订单产品表';
...
CREATE TABLE `ope_purchas_qc_trace` (
  ...
  `dr` int DEFAULT NULL COMMENT '删除标识',
  `part_id` bigint DEFAULT NULL COMMENT '部件Id',
  `purchas_id` bigint DEFAULT NULL COMMENT '采购单id',
  `purchas_b_qc_id` bigint DEFAULT NULL COMMENT '采购单子表Id',
  `part_qc_template_id` bigint DEFAULT NULL COMMENT '质检模板Id',
  `part_qc_template_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '模板质检项名称',
  `part_qc_template_b_id` bigint DEFAULT NULL COMMENT '质检结果Id',
  `part_qc_template_b_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '模板质检结果名称',
  `purchas_b_qc_item_id` bigint DEFAULT NULL COMMENT '质检条目Id',
  `part_qc_picture` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '质检图片的逗号分隔',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT '0' COMMENT '更新人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='采购单质检记录';
...
CREATE TABLE `ope_purchas_trace` (
  ...
  `tenant_id` bigint DEFAULT NULL COMMENT '租户Id',
  `user_id` bigint DEFAULT NULL COMMENT 'userId',
  `purchas_id` bigint NOT NULL COMMENT '采购订单id',
  `status` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '采购单状态',
  `event` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '事件',
  `event_time` datetime DEFAULT NULL COMMENT '事件时间',
  `memo` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注 放话术参数',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='采购订单节点表';
...
CREATE TABLE `ope_regional_price_sheet` (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '状态 状态',
  `parts_product_id` bigint DEFAULT NULL COMMENT '产品Id',
  ...
  `valid_flag` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '有效标识 标识当前区域报价是否生效',
  `currency_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '货币类型 如英镑，美元，人民币',
  `currency_unit` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '货币单位 如¥，$，€，	￡',
  `standard_currency` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '标准货币 用户货币转换',
  `exchange_rate` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '汇率 用于汇率转换',
  ...
  `def6` decimal(10,2) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='区域报价表';
...
CREATE TABLE `ope_regional_price_sheet_history` (
  ...
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `regional_price_sheet_id` bigint DEFAULT NULL COMMENT '区域报价主键 关联区域报价表',
  `parts_product_id` bigint DEFAULT NULL COMMENT '产品ID',
  `price_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '价格类型，1.销售价，2采购价，3其他价格',
  `sales_price` decimal(10,2) DEFAULT NULL COMMENT '销售价格 浮点型价格',
  `currency_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '货币类型 如英镑，美元，人民币',
  ...
  `def6` decimal(10,2) DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='区域报价表历史记录表';
...
CREATE TABLE `ope_stock` (
  ...
  `whse_id` bigint DEFAULT NULL COMMENT '所属仓库Id',
  `int_total` int DEFAULT NULL COMMENT '入库总数',
  `out_total` int DEFAULT NULL COMMENT '出库总数',
  `available_total` int DEFAULT NULL COMMENT '剩余库存',
  `worn_total` int DEFAULT NULL COMMENT '破损总数',
  `materiel_product_id` bigint DEFAULT NULL COMMENT '所属物料产品Id',
  `materiel_product_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属物料产品类型',
  `materiel_product_name` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属物料名称',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT '0' COMMENT '更新人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='库存总表';
...
CREATE TABLE `ope_stock_bill` (
  ...
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `stock_id` bigint DEFAULT NULL COMMENT '库存id',
  `direction` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '入库 0:In 出库 1:Out',
  `source_id` bigint DEFAULT NULL COMMENT '单据来源ID',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '状态:0正常，1异常',
  `total` int DEFAULT NULL COMMENT '入库单数量总计',
  `source_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '单据来源:1采购入库单，2采购入库单，3调拨入库单，4调拨出库单',
  `principal_id` bigint DEFAULT NULL COMMENT '负责人',
...
CREATE TABLE `ope_stock_prod_part` (
  ...
  `dr` int DEFAULT NULL,
  `user_id` bigint DEFAULT NULL COMMENT '用户id',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '可用、破损',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `stock_id` bigint DEFAULT NULL COMMENT '库存id',
  `part_id` bigint DEFAULT NULL COMMENT '物料ID',
  `lot` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '批次号',
  `in_stock_bill_id` bigint DEFAULT NULL COMMENT '入库单Id',
  `out_stock_bill_id` bigint DEFAULT NULL COMMENT '出库单Id',
  `serial_number` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '序列号',
  `parts_number` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部品号',
  `principal_id` bigint DEFAULT NULL COMMENT '入库负责人Id',
  `in__wh_qty` int DEFAULT NULL COMMENT '入库数量',
  `in_stock_time` datetime DEFAULT NULL COMMENT '入库时间',
  `out_stock_time` datetime DEFAULT NULL COMMENT '出库时间',
  `out_principal_id` bigint DEFAULT NULL COMMENT '出库负责人',
  `revision` int NOT NULL COMMENT '乐观锁',
  `created_by` bigint DEFAULT '0' COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint DEFAULT '0' COMMENT '更新人',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='生产原料库存';
...
CREATE TABLE `ope_stock_prod_product` (
  ...
  `lot` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '批次号',
  `serial_number` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '序列号',
  `product_number` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部件号',
  `in_stock_bill_id` bigint DEFAULT NULL COMMENT '入库单Id',
  `principal_id` bigint DEFAULT NULL COMMENT '入库负责人Id',
  `in__wh_qty` int DEFAULT NULL COMMENT '入库数量',
  `in_stock_time` datetime DEFAULT NULL COMMENT '入库时间',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='生产成品库';
...
CREATE TABLE `ope_stock_purchas` (
  ...
  `lot` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '批次号',
  `part_number` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '物料号',
  `serial_number` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '序列号:QC质检合格后产生',
  `principal_id` bigint DEFAULT NULL COMMENT '入库负责人Id',
  `in__wh_qty` int DEFAULT NULL COMMENT '入库数量',
  `in_stock_time` datetime DEFAULT NULL COMMENT '入库时间',
  `in_stock_bill_id` bigint DEFAULT NULL COMMENT '入库单Id',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='采购库存';
...
CREATE TABLE `ope_supplier` (
  ...
  `supplier_memo` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '采购商备注',
  `contact_first_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '联系人名字',
  `contact_last_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '联系人姓氏',
  `contact_full_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '联系人全名',
  `contact_email` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '联系人邮箱',
  ...
  `def6` double DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='采购商';
...
CREATE TABLE `ope_supplier_trace` (
  ...
  `tenant_id` bigint DEFAULT NULL COMMENT '租户ID',
  `user_id` bigint DEFAULT NULL COMMENT '用户ID',
  `status` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '采购商操作状态',
  `event` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '采购商操作事件',
  `event_time` datetime DEFAULT NULL COMMENT '事件时间',
  `reason` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注说明',
  `created_by` bigint NOT NULL DEFAULT '0' COMMENT '创建人',
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='采购商操作根据表';
...
CREATE TABLE `ope_sys_dept` (
  ...
  `dr` int NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `p_id` bigint DEFAULT NULL COMMENT '父级部门id',
  `tenant_id` bigint DEFAULT NULL COMMENT '租户id',
  `principal` bigint DEFAULT '0' COMMENT '负责人',
  `level` int NOT NULL DEFAULT '1' COMMENT '级别0公司，1部门',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部门名称',
  `code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '部门编码',
  `description` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '描述说明',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1004233 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部门管理';
...
CREATE TABLE `ope_sys_menu` (
  ...
  `dr` int NOT NULL DEFAULT '0' COMMENT '逻辑删除标识',
  `p_id` bigint DEFAULT NULL COMMENT '父菜单ID',
  ...
  `path` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '路由',
  `component` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '对应路由组件component',
  `type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '菜单类型：0菜单，1按钮，3开放API',
  `icon` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '图表',
  `level` int DEFAULT '0' COMMENT '等级',
  `sort` int DEFAULT '1' COMMENT '菜单权重',
  ...
  `def6` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1010482 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1012560 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='系统角色表';
...
CREATE TABLE `ope_sys_role_sales_cidy` (
  `role_id` bigint DEFAULT NULL COMMENT '用户ID',
  `city_id` bigint DEFAULT NULL COMMENT '城市ID',
  UNIQUE KEY `ope_sys_user_sales_cidy_user_id_city_id_uindex` (`role_id`,`city_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户销售区域关系表';
...
CREATE TABLE `ope_sys_staff` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int DEFAULT '0' COMMENT '逻辑删除标识 0正常 1删除',
  `status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '状态：In-service在职，Leave离职',
  ...
  `def6` double(20,0) DEFAULT '0' COMMENT '冗余字段',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `ope_sys_staff_sys_user_id_uindex` (`sys_user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户员工表';
...
CREATE TABLE `ope_sys_user` (
  `id` bigint NOT NULL COMMENT 'ID',
  `dr` int DEFAULT '0' COMMENT '逻辑删除标识 0正常 1删除',
  `dept_id` bigint NOT NULL DEFAULT '0' COMMENT '组织部门ID',
  `org_staff_id` bigint NOT NULL DEFAULT '0' COMMENT '员工主键',
  `app_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '应用ID',
  `system_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统Id',
  ...
  `status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '状态 Normal,Lock,Cancel，Expired',
  `login_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '登录名',
  `last_login_time` datetime DEFAULT NULL COMMENT '最后登录时间',
  `last_login_token` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '最后登录TOKEN',
  `last_login_ip` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '最后登录IP地址',
...
-- ----------------------------
BEGIN;
INSERT INTO `ope_sys_user` VALUES (1000003, 0, 1000000, 0, '4', 'REDE_SES', '214ac9c07191d0646839138808f7ee46', '31822', '1', 'admin@redescooter.com', '2020-06-14 09:50:02', 'c90e2c5e3321428d90ae89cb77145354', '192.168.2.220', '2020-06-14', NULL, 0, '2020-06-14 09:48:19', 0, '2020-06-25 00:55:48', '1', NULL, NULL, NULL, 0);
COMMIT;
...
CREATE TABLE `ope_sys_user_profile` (
  `id` bigint NOT NULL COMMENT 'ID',
  `dr` int DEFAULT '0' COMMENT '逻辑删除标识 0正常 1删除',
  `repair_shop_Id` bigint NOT NULL DEFAULT '0' COMMENT '维修店ID',
  `sys_user_id` bigint NOT NULL DEFAULT '0' COMMENT '用户ID',
  `picture` varchar(2048) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '照片',
  `first_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '名',
  `last_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '姓',
  `full_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '全名',
  `email` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '邮箱',
  `country_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '国家编码如+86',
  `tel_number` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '电话号',
  `gender` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '性别 Male 男 Female 女',
  `birthday` date DEFAULT NULL COMMENT '生日',
  `place_birth` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '出生地',
  `address_country_code` varchar(48) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '地址国家编码',
  `address` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '地址',
  `address_bureau` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '办公地点Id(具体数据可查看 AddressBureauEnums )',
  `certificate_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '证件类型，1身份证，2驾驶证，3护照',
  `certificate_negative_annex` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '证件正面',
  `certificate_positive_annex` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '证件背面',
...
-- ----------------------------
BEGIN;
INSERT INTO `ope_sys_user_profile` VALUES (1000003, 0, 0, 1000003, NULL, 'ADMIN', 'ADNIN', 'ROOT ROOT', 'admin@redescooter.com', '33', '30690', NULL, '2020-06-18', NULL, NULL, NULL, '1000000', NULL, NULL, NULL, NULL, 0, '2020-06-14 09:48:19', 0, '2020-06-25 00:56:49', NULL, NULL, NULL, NULL, 0);
COMMIT;
...
CREATE TABLE `ope_whse` (
  `id` bigint NOT NULL COMMENT '主键',
  `dr` int NOT NULL DEFAULT '0' COMMENT '逻辑删除字段',
  `name` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '分类名称',
  `code` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '分类编码',
  `product_range` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '产品范围',
  `type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仓库类型，1采购，2生产，3销售',
  `remark` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `country_id` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '国家',
  `city_id` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '城市id',
