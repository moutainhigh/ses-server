...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '摩托车'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `user_id`               bigint(11)                                             NULL     DEFAULT NULL COMMENT '司机ID',
    ...
    `battery`               int(11)                                                NULL     DEFAULT NULL COMMENT '电池电量',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '车辆操作记录'
  ROW_FORMAT = Dynamic;
...
(
    `id`               bigint(20)                                             NOT NULL COMMENT 'ID',
    `dr`               int(20)                                                NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `scooter_id`       bigint(20)                                             NULL     DEFAULT NULL COMMENT '电动车ID',
    `begin_time`       datetime(0)                                            NULL     DEFAULT NULL COMMENT '充电开始时间',
    `end_time`         datetime(0)                                            NULL     DEFAULT NULL COMMENT '充电结束时间',
    `charged_duration` bigint(20)                                             NULL     DEFAULT NULL COMMENT '充电时长',
    `begin_battery`    int(32)                                                NULL     DEFAULT NULL COMMENT '开始充电电量',
    `end_battery`      int(32)                                                NULL     DEFAULT NULL COMMENT '结束充电电量',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '车辆充电表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '智能控制系统'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `revision`     int(11)                                                NULL     DEFAULT NULL COMMENT '乐观锁',
    `created_by`   bigint(32)                                             NULL     DEFAULT NULL COMMENT '创建人',
    `created_time` datetime(0)                                            NULL     DEFAULT NULL COMMENT '创建时间',
    `updated_by`   bigint(32)                                             NULL     DEFAULT NULL COMMENT '更新人',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '控制器 '
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '导航表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '摩托车OBD检测'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '摩托车OBD详情'
  ROW_FORMAT = Dynamic;
...
(
    `id`                 bigint(20)                                             NOT NULL COMMENT 'ID',
    `dr`                 int(20)                                                NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `scooter_id`         bigint(20)                                             NULL     DEFAULT NULL COMMENT '车辆ID',
    ...
    `repair_duration`    int(11)                                                NULL     DEFAULT NULL COMMENT '维修时长',
    `created_by`         bigint(20)                                             NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_time`       datetime(0)                                            NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
    `updated_by`         bigint(20)                                             NOT NULL DEFAULT 0 COMMENT '更新人',
    `updated_time`       datetime(0)                                            NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '车辆维修表'
  ROW_FORMAT = Dynamic;
...
(
    `id`           bigint(20)                                              NOT NULL COMMENT 'ID',
    `dr`           int(20)                                                 NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `repair_id`    bigint(20)                                              NULL     DEFAULT NULL COMMENT '维修ID',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '维修详情'
  ROW_FORMAT = Dynamic;
...
(
    `scooter_id`   bigint(11)                                             NULL DEFAULT NULL COMMENT '车辆ID',
    `dr`           int(20)                                                NULL DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `sparepart_id` bigint(11)                                             NULL DEFAULT NULL COMMENT '配件ID',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '摩托车配件'
  ROW_FORMAT = Dynamic;
...
(
    `id`                 bigint(11)                                             NOT NULL COMMENT 'ID',
    `dr`                 int(20)                                                NULL DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `scooter_ecu_id`     bigint(11)                                             NULL DEFAULT NULL COMMENT '智能控制系统ID',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '电动车实时信息'
  ROW_FORMAT = Dynamic;
...
(
    `id`           bigint(11)                                             NULL DEFAULT NULL COMMENT 'ID',
    `dr`           int(20)                                                NULL DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `revision`     int(11)                                                NULL DEFAULT NULL COMMENT '乐观锁',
    `created_by`   bigint(32)                                             NULL DEFAULT NULL COMMENT '创建人',
    `created_time` datetime(0)                                            NULL DEFAULT NULL COMMENT '创建时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '摩托车后备箱'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '配件表'
  ROW_FORMAT = Dynamic;
