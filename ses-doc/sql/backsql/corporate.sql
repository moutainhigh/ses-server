...
(
    ...
    `deliverer_id`      bigint(11)                                              NULL     DEFAULT NULL COMMENT '交付人,即司机账号的USER_ID字段的值',
    `scooter_id`        bigint(11)                                              NULL     DEFAULT NULL COMMENT 'scooterId',
    `recipient`         varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '收件人',
    `recipient_email`   varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '收件人邮箱',
    ...
    `recipient_address` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '收件人地址',
    ...
    `parcel_quantity`   int(11)                                                 NULL     DEFAULT NULL COMMENT '包裹数量',
    ...
    `driven_duration`   int(11)                                                 NULL     DEFAULT NULL COMMENT '骑行时长',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '递送单'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `dr`                       int(20)                                                 NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `delivery_id`              bigint(20)                                              NULL     DEFAULT NULL COMMENT 'deliveryId',
    `tenant_id`                bigint(11)                                              NULL     DEFAULT NULL COMMENT '租户ID',
    `user_id`                  bigint(11)                                              NULL     DEFAULT NULL COMMENT 'userId,即delivery表中的交付人id同时是司机的user_id',
    ...
    `geohash`                  varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT 'GEOHASH',
    `scooter_id`               bigint(32)                                              NULL     DEFAULT NULL COMMENT 'scooterId',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'Delivery操作跟踪表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `score`                int(11)                                                 NULL     DEFAULT 3 COMMENT '评分',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '司机'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `total_duration`  bigint(20)                                             NULL DEFAULT NULL COMMENT '总时长',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '司机骑行统计数据'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `driver_id`         bigint(20)                                             NOT NULL COMMENT '司机主键',
    `duration`          bigint(20)                                             NULL DEFAULT NULL COMMENT '本次时长',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '司机骑行统计数据明细'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `dr`           int(20)                                                 NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `tenant_id`    bigint(11)                                              NULL     DEFAULT NULL COMMENT '租户ID',
    `driver_id`    bigint(11)                                              NULL     DEFAULT NULL COMMENT '司机ID',
    `scooter_id`   bigint(11)                                              NULL     DEFAULT NULL COMMENT '车辆ID',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '司机分配车辆表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '司机分配车辆表历史记录表'
  ROW_FORMAT = Dynamic;
...
(
    `id`                  bigint(20)                                             NOT NULL COMMENT '主键',
    `dr`                  int(20)                                                NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `tenant_id`           bigint(20)                                             NULL     DEFAULT NULL COMMENT '租户表',
    `scooter_Id`          bigint(20)                                             NULL     DEFAULT NULL,
    ...
    `driven_duration`     int(11)                                                NULL     DEFAULT 0 COMMENT '行驶时长',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '快递递送单'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '快递订单子表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `recipient_mail`      varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL DEFAULT NULL COMMENT '收件方邮箱',
    ...
    `sender_mail`         varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL DEFAULT NULL COMMENT '发货人邮箱',
    `sender_notes`        varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发货方备注',
    `parcel_quantity`     int(11)                                                 NULL DEFAULT 1 COMMENT '包裹数',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '快递订单表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `dr`                  int(20)                                                 NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `express_delivery_id` bigint(20)                                              NULL     DEFAULT NULL COMMENT 'deliveryId',
    `tenant_id`           bigint(11)                                              NULL     DEFAULT NULL COMMENT '租户ID',
    `express_order_id`    bigint(11)                                              NULL     DEFAULT NULL COMMENT '完成时订单id',
    `driver_id`           bigint(11)                                              NULL     DEFAULT NULL COMMENT '交付人id',
    `status`              varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '订单状态',
    `event`               varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '事件',
    `reason`              varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '订单取消时，存储取消原因；订单拒绝时，存储拒绝原因；',
    `event_time`          datetime(0)                                             NULL     DEFAULT NULL COMMENT '事件时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '快递订单操作跟踪表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `tenant_id`    bigint(20)                                             NULL     DEFAULT NULL COMMENT '门店Id',
    `scooter_id`   bigint(20)                                             NULL     DEFAULT NULL COMMENT '已分配：allocation已写卡：available已失效：unavailable（暂时不要）空闲：FREE',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'RFID表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '车辆骑行统计数据'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '车辆骑行统计数据明细'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `scooter_id`            bigint(32)                                              NULL     DEFAULT NULL COMMENT '车辆ID',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '租户车辆表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `is_master`                  int(11)                                                  NULL     DEFAULT 0 COMMENT '是否主账号:1-主账号,0-子账号',
    ...
    `email_1`                    varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '邮箱',
    `email_2`                    varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '邮箱',
    `email_3`                    varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '邮箱',
