...
(
    ...
    `dr`                     int(11)                                                      NULL DEFAULT NULL COMMENT '删除标识',
    ...
    `consignee_id`           bigint(20)                                                   NULL DEFAULT NULL COMMENT '收获人Id',
    `preparation_wait_total` int(11)                                                      NULL DEFAULT NULL COMMENT '待备料总数',
    `pending_storage_total`  int(11)                                                      NULL DEFAULT NULL COMMENT '待入库数量',
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '调拨单'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `user_id`               bigint(20)                                                   NULL DEFAULT NULL COMMENT 'userId',
    `tenant_id`             bigint(20)                                                   NULL DEFAULT NULL COMMENT '租户Id',
    `allocate_id`           bigint(20)                                                   NULL DEFAULT NULL COMMENT '调拨单Id',
    `part_id`               bigint(20)                                                   NULL DEFAULT NULL COMMENT '部件Id',
    `materiel_product_id`   bigint(20)                                                   NULL DEFAULT NULL COMMENT '产品物料id',
    ...
    `preparation_wait_qty`  int(11)                                                      NULL DEFAULT NULL COMMENT '待备料总数',
    `pending_storage_qty`   int(11)                                                      NULL DEFAULT NULL COMMENT '待入库数量',
    `revision`              int(11)                                                      NOT NULL COMMENT '乐观锁',
    `created_by`            bigint(20)                                                   NULL DEFAULT 0 COMMENT '创建人',
    `created_time`          datetime(0)                                                  NULL DEFAULT NULL COMMENT '创建时间',
    `updated_by`            bigint(20)                                                   NULL DEFAULT 0 COMMENT '更新人',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '调拨单子表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `dr`            int(11)                                                      NULL DEFAULT NULL COMMENT '删除标识',
    `allocate_id`   bigint(20)                                                   NULL DEFAULT NULL COMMENT '调拨单Id',
    `allocate_b_id` bigint(20)                                                   NULL DEFAULT NULL COMMENT '调拨单子表Id',
    `part_id`       bigint(20)                                                   NULL DEFAULT NULL COMMENT '部件Id',
    `batch_no`      varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '批次号',
    `qty`           int(11)                                                      NULL DEFAULT NULL COMMENT '备料数量',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '调拨备料记录表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '调拨单节点表'
  ROW_FORMAT = Dynamic;
...
(
    `id`                    bigint(20)                                             NOT NULL COMMENT '主键',
    `dr`                    int(11)                                                NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `ope_assembiy_order_id` bigint(20)                                             NULL     DEFAULT NULL COMMENT '组装单主键',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '组装单节点表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `user_id`           bigint(20)                                                   NULL     DEFAULT NULL COMMENT '用户id',
    `tenant_id`         bigint(20)                                                   NULL     DEFAULT NULL COMMENT '租户id',
    `assembly_id`       bigint(20)                                                   NULL     DEFAULT NULL COMMENT '组装单id',
    ...
    `wait_assembly_qty` int(11)                                                      NULL     DEFAULT NULL COMMENT '待组装数量',
    `in_wait_wh_qty`    int(11)                                                      NULL     DEFAULT NULL COMMENT '待入库数',
    `lave_wait_qc_qty`  int(11)                                                      NULL     DEFAULT NULL COMMENT '待质检数',
    `assembly_qty`      int(11)                                                      NULL     DEFAULT NULL COMMENT '组装总数量',
    `complete_qty`      int(11)                                                      NULL     DEFAULT NULL COMMENT '完成组装数',
    `revision`          int(11)                                                      NOT NULL DEFAULT 0 COMMENT '乐观锁',
    `created_by`        bigint(20)                                                   NULL     DEFAULT 0 COMMENT '创建表',
    `created_time`      datetime(0)                                                  NULL     DEFAULT NULL COMMENT '创建时间',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '组装单产品明细表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `tenant_id`               bigint(20)                                                 NULL     DEFAULT NULL COMMENT '租户Id',
    `user_id`                 bigint(20)                                                 NULL     DEFAULT NULL COMMENT 'userId',
    `assembly_b_id`           bigint(20)                                                 NULL     DEFAULT NULL COMMENT '组装子表Id',
    `product_id`              bigint(20)                                                 NULL     DEFAULT NULL COMMENT '产品Id',
    `quality_inspector_id`    bigint(20)                                                 NULL     DEFAULT NULL COMMENT '质检人Id',
    ...
    `total_quality_inspected` int(11)                                                    NULL     DEFAULT NULL COMMENT '需要质检总数',
    `pass_count`              int(11)                                                    NULL     DEFAULT NULL COMMENT '质检通过数量',
    `fail_count`              int(11)                                                    NULL     DEFAULT NULL COMMENT '质检失败数量',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '采购条目QC质检'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `tenant_id`               bigint(20)                                                 NULL     DEFAULT NULL COMMENT '租户Id',
    `user_id`                 bigint(20)                                                 NULL     DEFAULT NULL COMMENT 'userId',
    `assembly_id`             bigint(20)                                                 NULL     DEFAULT NULL COMMENT '组装表Id',
    `quality_inspector_id`    bigint(20)                                                 NULL     DEFAULT NULL COMMENT '质检人Id',
    `batch_no`                varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL     DEFAULT NULL COMMENT '质检批次号',
    `total_quality_inspected` int(11)                                                    NULL     DEFAULT NULL COMMENT '需要质检总数',
    `pass_count`              int(11)                                                    NULL     DEFAULT NULL COMMENT '质检通过数量',
...
(
    `id`                     bigint(20)                                                    NOT NULL COMMENT '主键',
    `dr`                     int(11)                                                       NULL     DEFAULT NULL COMMENT '逻辑删除标识',
    `user_id`                bigint(20)                                                    NULL     DEFAULT NULL COMMENT '用户id',
    ...
    `total_qty`              int(11)                                                       NULL     DEFAULT NULL COMMENT '产品数量之和',
    ...
    `factory_id`             bigint(20)                                                    NULL     DEFAULT NULL COMMENT '代工厂id',
    `factory_annex`          varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '工厂附件',
    `consignee_id`           bigint(20)                                                    NULL     DEFAULT NULL COMMENT '收货人姓氏',
    `wait_assembly_total`    int(11)                                                       NULL     DEFAULT NULL COMMENT '待组装总数量',
    `in_wait_wh_total`       int(11)                                                       NULL     DEFAULT NULL COMMENT '待入库总数',
    `lave_wait_qc_total`     int(11)                                                       NULL     DEFAULT NULL COMMENT '待质检总数',
    `wait_preparation_total` int(11)                                                       NULL     DEFAULT NULL COMMENT '待备料数量',
    `revision`               int(11)                                                       NOT NULL DEFAULT 0 COMMENT '乐观锁',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '组装单'
  ROW_FORMAT = Dynamic;
...
(
    `id`                   bigint(20)                                             NOT NULL COMMENT '主键',
    `dr`                   int(11)                                                NULL     DEFAULT NULL COMMENT '逻辑删除标识',
    `stock_id`             bigint(20)                                             NULL     DEFAULT NULL COMMENT '库存Id',
    `part_id`              bigint(20)                                             NULL     DEFAULT NULL COMMENT '部件Id',
    `assembly_id`          bigint(20)                                             NULL     DEFAULT NULL COMMENT '组装单Id',
    `total_qty`            int(11)                                                NULL     DEFAULT NULL COMMENT '消耗部件数量',
    `wait_preparation_qty` int(11)                                                NULL     DEFAULT NULL COMMENT '待备料数量',
    `revision`             int(11)                                                NOT NULL DEFAULT 0 COMMENT '乐观锁',
    `created_by`           bigint(20)                                             NULL     DEFAULT NULL COMMENT '创建人',
    `created_time`         datetime(0)                                            NULL     DEFAULT NULL COMMENT '创建时间',
    `updated_by`           bigint(20)                                             NULL     DEFAULT NULL COMMENT '更新人',
...
(
    ...
    `tenant_id`             bigint(20)                                             NULL     DEFAULT NULL COMMENT '租户Id',
    `user_id`               bigint(20)                                             NULL     DEFAULT NULL COMMENT 'userId',
    `ope_assembly_order_id` bigint(20)                                             NULL     DEFAULT NULL COMMENT '组装单主键',
    ...
    `payment_day`           int(11)                                                NULL     DEFAULT NULL COMMENT '付款周期',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '组装单付款表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `tenant_id`              bigint(20)                                                   NULL     DEFAULT 0 COMMENT '租户id',
    `assembly_id`            bigint(20)                                                   NULL     DEFAULT NULL COMMENT '组装单Id',
    `assembly_order_part_id` bigint(20)                                                   NULL     DEFAULT NULL COMMENT '组装部品表Id',
    `part_id`                bigint(20)                                                   NULL     DEFAULT NULL COMMENT '部件Id',
    `serial_num`             varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '序列号',
    `batch_no`               varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '批次号',
    `qty`                    int(11)                                                      NULL     DEFAULT NULL COMMENT '备料数量',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '组装备料记录表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `dr`               int(11)                                                      NULL DEFAULT NULL COMMENT '删除标识',
    `assembly_id`      bigint(20)                                                   NULL DEFAULT NULL COMMENT '组装单id',
    `assembly_b_id`    bigint(20)                                                   NULL DEFAULT NULL COMMENT '组装单子表Id',
    `assembly_b_qc_id` bigint(20)                                                   NULL DEFAULT NULL COMMENT '质检结果表',
    `product_id`       bigint(20)                                                   NULL DEFAULT NULL COMMENT '产品Id',
    `assembly_lot_id`  bigint(20)                                                   NULL DEFAULT NULL COMMENT '批次质检记录id',
    `serial_num`       varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '序列号',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '组装单质检条目'
  ROW_FORMAT = Dynamic;
...
(
    `id`                         bigint(20)                                                    NOT NULL COMMENT '主键',
    `dr`                         int(11)                                                       NULL DEFAULT NULL COMMENT '删除标识',
    `ope_assembly_b_id`          bigint(20)                                                    NULL DEFAULT NULL COMMENT '组装单子表id',
    `product_qc_template_b_id`   bigint(20)                                                    NULL DEFAULT NULL COMMENT '质检项结果Id',
    `product_qc_template_b_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '质检结果',
    `product_qc_template_id`     bigint(20)                                                    NULL DEFAULT NULL COMMENT '质检项Id',
    `product_qc_template_name`   varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '质检项名称',
    `assembly_qc_item_id`        bigint(20)                                                    NULL DEFAULT NULL COMMENT '商品质检条目',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '组装单质检记录'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_color
-- ----------------------------
DROP TABLE IF EXISTS `ope_color`;
CREATE TABLE `ope_color`
(
    `id`           bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '主键',
    `dr`           int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `color_name`   varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '颜色名称',
    `color_value`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '色值',
    ...
    `def4`         varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '冗余字段',
    `def5`         decimal(10, 6)                                               NULL     DEFAULT NULL COMMENT '冗余字段',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '颜色表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_contact_us
-- ----------------------------
DROP TABLE IF EXISTS `ope_contact_us`;
CREATE TABLE `ope_contact_us`
(
    `id`            bigint(20)                                               NOT NULL COMMENT '主键',
    `dr`            int(11)                                                  NULL     DEFAULT 0 COMMENT '删除标志',
    ...
    `telephone`     varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '电话',
    `country`       bigint(20)                                               NULL     DEFAULT NULL COMMENT '国家Id',
    `country_code`  varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '国家代码',
    ...
    `district`      bigint(20)                                               NULL     DEFAULT NULL COMMENT '区域Id',
    `district_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '区域编码',
    `address`       varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '地址',
    `frequency`     int(11)                                                  NULL     DEFAULT NULL COMMENT '联系次数',
    ...
    `updated_by`    bigint(20)                                               NOT NULL DEFAULT 0 COMMENT '更新人',
    `updated_time`  datetime(3)                                              NULL     DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
    `def1`          varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '冗余字段',
    `def2`          varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '冗余字段',
    `def3`          varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '冗余字段',
    `def5`          varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '冗余字段',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '官网联系我们'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_contact_us_trace
-- ----------------------------
...
(
    ...
    `full_name`     varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '全名',
    `telephone`     varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '电话',
    `country_name`  varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '国家名称',
    `city_name`     varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '城市名称',
    `district_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '区域编码',
    `address`       varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '地址',
    `remark`        varchar(4096) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '备注',
    `message_type`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '消息类型：1.留言 2回复',
    `leave_word_id` bigint(20)                                               NULL     DEFAULT NULL COMMENT '留言id',
    `created_by`    bigint(20)                                               NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_time`  datetime(3)                                              NULL     DEFAULT NULL COMMENT '创建时间',
    `updated_by`    bigint(20)                                               NOT NULL DEFAULT 0 COMMENT '更新人',
    `updated_time`  datetime(3)                                              NULL     DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '官网联系我们历史记录'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `country`                    bigint(20)                                              NULL     DEFAULT NULL COMMENT '国家',
    ...
    `distrust`                   bigint(20)                                              NULL     DEFAULT NULL COMMENT '区域',
    `status`                     varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '状态',
    ...
    `scooter_quantity`           int(11)                                                 NULL     DEFAULT NULL COMMENT '车辆数量',
    `assignation_scooter_qty`    int(11)                                                 NULL     DEFAULT NULL COMMENT '已分配车辆数',
    ...
    `description`                varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '删除说明',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '客户表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `product_id`   bigint(20)                                             NULL     DEFAULT NULL COMMENT '适用于产品的产品Id',
    `created_by`   bigint(20)                                             NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_time` datetime(0)                                            NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
    `updated_by`   bigint(20)                                             NOT NULL DEFAULT 0 COMMENT '更新人',
    `updated_time` datetime(0)                                            NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '产品配件表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '客户联系人表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `country`           bigint(20)                                              NULL     DEFAULT NULL COMMENT '国家',
    `city`              bigint(20)                                              NULL     DEFAULT NULL COMMENT '城市',
    `district`          bigint(20)                                              NULL     DEFAULT NULL COMMENT '区域',
    `customer_source`   varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '客户来源渠道 官网/email/电话',
    `sales_id`          bigint(20)                                              NULL     DEFAULT NULL COMMENT '销售员id',
    ...
    `scooter_quantity`  int(11)                                                 NULL     DEFAULT NULL COMMENT '需求车辆数',
    ...
    `def3`              varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '冗余字段',
    `def5`              varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '冗余字段',
    `def6`              double(20, 0)                                           NULL     DEFAULT NULL COMMENT '冗余字段',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '客户咨询管理'
  ROW_FORMAT = Dynamic;
...
(
    `id`            bigint(20)                                             NOT NULL COMMENT 'id',
    `dr`            int(11)                                                NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `inquiry_id`    bigint(20)                                             NULL     DEFAULT NULL COMMENT '询价单Id',
    `product_id`    bigint(20)                                             NULL     DEFAULT NULL COMMENT '产品Id',
    `product_price` decimal(10, 2)                                         NULL     DEFAULT NULL COMMENT '产品价格',
    `product_qty`   int(11)                                                NULL     DEFAULT NULL COMMENT '产品数量',
...
-- ----------------------------
-- Table structure for ope_delivery_option
-- ----------------------------
...
(
    ...
    `option_code`  varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '交货方式编码',
    `option_neme`  varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '交货名称',
    `price`        double                                                        NOT NULL DEFAULT 0,
    `memo`         varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '备注说明',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '交货方式'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_distrust_lead
-- ----------------------------
DROP TABLE IF EXISTS `ope_distrust_lead`;
CREATE TABLE `ope_distrust_lead`
(
    `id`            bigint(20)                                             NOT NULL COMMENT 'ID',
    `dr`            int(11)                                                NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `city_name`     varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '城市',
    `distrust_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '区域邮编',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '区域负责人表'
  ROW_FORMAT = Dynamic;
...
(
    `id`           bigint(20)                                             NOT NULL COMMENT 'ID',
    `dr`           int(11)                                                NULL     DEFAULT NULL COMMENT '逻辑删除标识 0正常 1删除',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '表格导入记录表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '代工厂'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '代工厂操作根据表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_fr_stock
-- ----------------------------
...
(
    ...
    `whse_id`               bigint(20)                                             NULL DEFAULT NULL COMMENT '所属仓库Id',
    `int_total`             int(11)                                                NULL DEFAULT NULL COMMENT '入库总数',
    `out_total`             int(11)                                                NULL DEFAULT NULL COMMENT '出库总数',
    `available_total`       int(11)                                                NULL DEFAULT NULL COMMENT '剩余库存',
    `worn_total`            int(11)                                                NULL DEFAULT NULL COMMENT '破损总数',
    `lock_total`            int(11)                                                NULL DEFAULT NULL COMMENT '锁定库存',
    `materiel_product_id`   bigint(20)                                             NULL DEFAULT NULL COMMENT '所属物料产品Id',
    `materiel_product_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属物料产品类型',
    `materiel_product_name` varchar(48) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属物料名称',
    `revision`              int(11)                                                NOT NULL COMMENT '乐观锁',
    `created_by`            bigint(20)                                             NULL DEFAULT 0 COMMENT '创建人',
    `created_time`          datetime(3)                                            NULL DEFAULT NULL COMMENT '创建时间',
    `updated_by`            bigint(20)                                             NULL DEFAULT 0 COMMENT '更新人',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '法国仓库库存表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_fr_stock_bill
-- ----------------------------
...
(
    ...
    `principal_id`   bigint(20)                                                   NULL     DEFAULT NULL COMMENT '负责人',
...
-- ----------------------------
-- Table structure for ope_fr_stock_product
-- ----------------------------
...
(
    ...
    `dr`                int(11)                                                NULL DEFAULT NULL,
    `status`            varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '可用、破损',
    `stock_id`          bigint(20)                                             NULL DEFAULT NULL COMMENT '库存id',
    `product_id`        bigint(20)                                             NULL DEFAULT NULL COMMENT '商品Id',
    `lot`               varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '批次号',
    `serial_number`     varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '序列号',
    `product_number`    varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '部件号',
    `product_type`      varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '产品类型',
    `in_stock_bill_id`  bigint(20)                                             NULL DEFAULT NULL COMMENT '入库单Id',
    `principal_id`      bigint(20)                                             NULL DEFAULT NULL COMMENT '入库负责人Id',
    `in_wh_qty`         int(11)                                                NULL DEFAULT NULL COMMENT '入库数量',
    `in_stock_time`     datetime(0)                                            NULL DEFAULT NULL COMMENT '入库时间',
    `out_stock_bill_id` bigint(20)                                             NULL DEFAULT NULL COMMENT '出库单Id',
    `source_type`       varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单据来源',
    `out_principal_id`  bigint(20)                                             NULL DEFAULT NULL COMMENT '出库负责人',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '法国仓库成品库'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_outwh_order
-- ----------------------------
DROP TABLE IF EXISTS `ope_outwh_order`;
CREATE TABLE `ope_outwh_order`
(
    `id`                bigint(20)                                              NOT NULL COMMENT '主键 主键',
    `dr`                int(11)                                                 NULL     DEFAULT NULL COMMENT '逻辑删除标识 逻辑删除标识',
    `order_no`          varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '订单编号',
    `tracking_num`      varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '物流编号',
    `in_wh_id`          bigint(20)                                              NULL     DEFAULT NULL COMMENT '入库仓库Id',
    `address`           varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '收货地址',
    `consignee_id`      bigint(20)                                              NULL     DEFAULT NULL COMMENT '收货人Id（userId）',
    `consignee_phone`   varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '收货人电话',
    `country_code`      varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '电话国家代码',
    `consignee_email`   varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '收货人邮箱',
    `notify_first_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '通知人姓名',
    `notify_last_name`  varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '通知人姓名',
    `consign_type`      varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '物流方式',
    `consign_method`    varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '委托方式',
    `consign_company`   varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '物流公司',
    `annex`             varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '发货发票',
    `status`            varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '状态',
    `product_count`     int(11)                                                 NULL     DEFAULT NULL COMMENT '产品总数',
    `logistics_price`   decimal(10, 2)                                          NULL     DEFAULT NULL COMMENT '物流价格',
    `created_by`        bigint(20)                                              NULL     DEFAULT 0 COMMENT '创建人',
    `created_time`      datetime(3)                                             NULL     DEFAULT NULL COMMENT '创建时间',
    `updated_by`        bigint(20)                                              NULL     DEFAULT 0 COMMENT '更新人',
    `updated_time`      datetime(3)                                             NULL     DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '中国生产仓库出库单'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_outwh_order_b
-- ----------------------------
...
(
    `id`              bigint(20)                                             NOT NULL COMMENT '主键 主键',
    `dr`              int(11)                                                NULL     DEFAULT NULL COMMENT '逻辑删除标识 逻辑删除标识',
    `outwh_order_id`  bigint(20)                                             NULL     DEFAULT NULL COMMENT '出库单id',
    `stock_id`        bigint(20)                                             NULL     DEFAULT NULL COMMENT '库存Id',
    `part_product_id` bigint(20)                                             NULL     DEFAULT NULL COMMENT '部件产品Id 和 下面的来源一起使用',
    `product_type`    varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '产品类型 ',
    `total_count`     int(11)                                                NULL     DEFAULT NULL COMMENT '总数量',
    `last_out_count`  int(11)                                                NULL     DEFAULT NULL COMMENT '剩余出货数量',
    `status`          varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '状态',
    `created_by`      bigint(20)                                             NULL     DEFAULT 0 COMMENT '创建人',
    `created_time`    datetime(3)                                            NULL     DEFAULT NULL COMMENT '创建时间',
    `updated_by`      bigint(20)                                             NULL     DEFAULT 0 COMMENT '更新人',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '中国生产仓库出库单子表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_outwh_trace
-- ----------------------------
...
(
    `id`              bigint(20)                                             NOT NULL COMMENT '主键 主键',
    `dr`              int(11)                                                NULL     DEFAULT NULL COMMENT '逻辑删除标识 逻辑删除标识',
    `wh_out_order_id` bigint(20)                                             NULL     DEFAULT NULL COMMENT '出库单id',
    `status`          varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '采购单状态',
    `event`           varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '事件',
    `event_time`      datetime(0)                                            NULL     DEFAULT NULL COMMENT '事件时间',
    `memo`            varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '备注 放话术参数',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '中国生产仓库出库单节点表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `part_draft_id`         bigint(20)                                                    NULL DEFAULT NULL COMMENT '部件Id',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '部件质检模板'
  ROW_FORMAT = Dynamic;
...
(
    `id`                        bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`                        int(11)                                                      NOT NULL COMMENT '逻辑删除',
    `part_draft_qc_template_id` bigint(20)                                                   NULL DEFAULT NULL COMMENT '质检项Id',
    `qc_result`                 varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '质检结果',
    `pass_flag`                 tinyint(1)                                                   NULL DEFAULT NULL COMMENT '通过标记',
    `upload_flag`               tinyint(1)                                                   NULL DEFAULT NULL COMMENT '是否允许上传图片',
    `results_sequence`          int(11)                                                      NULL DEFAULT NULL COMMENT '结果集排序优先级',
    `revision`                  int(11)                                                      NOT NULL COMMENT '乐观锁',
    `created_by`                bigint(20)                                                   NOT NULL COMMENT '创建人',
    `created_time`              datetime(0)                                                  NOT NULL COMMENT '创建时间',
    `updated_by`                bigint(20)                                                   NOT NULL COMMENT '更新人',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '部件质检模板结果项'
  ROW_FORMAT = Dynamic;
...
(
    `id`                  bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`                  int(11)                                                      NOT NULL COMMENT '逻辑删除',
    `part_qc_template_id` bigint(20)                                                   NULL DEFAULT NULL COMMENT '质检项Id',
    `qc_result`           varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '质检结果',
    `pass_flag`           tinyint(4)                                                   NULL DEFAULT NULL COMMENT '通过标记',
    `upload_flag`         tinyint(1)                                                   NULL DEFAULT NULL COMMENT '是否允许上传图片',
    `results_sequence`    int(11)                                                      NULL DEFAULT NULL COMMENT '结果集排序优先级',
    `revision`            int(11)                                                      NOT NULL COMMENT '乐观锁',
    `created_by`          bigint(20)                                                   NOT NULL COMMENT '创建人',
...
(
    ...
    `parts_qty`        int(11)                                                       NULL     DEFAULT NULL COMMENT '部品数量',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '物料表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '物料草稿表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'BOM产品部件草稿表操作记录表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '部件产品表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `parts_qty`        int(11)                                                      NOT NULL DEFAULT 0 COMMENT '部品数量 数量',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '部件产品表条目'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '部品项目区域表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '部品类型表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `parts_id`          bigint(20)                                                   NULL     DEFAULT NULL COMMENT '部品主键 用于关联部品',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '报价列表 报价列表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `user_id`           bigint(20)                                                   NOT NULL COMMENT '用户ID 用户ID',
    `parts_id`          bigint(20)                                                   NULL DEFAULT NULL COMMENT '部品主键 用于关联部品',
    `price_sheet_id`    bigint(20)                                                   NULL DEFAULT NULL COMMENT '报价表主键 用于关联报价表',
    `price`             decimal(10, 2)                                               NULL DEFAULT NULL COMMENT '价格 浮点型价格',
    `currency_type`     varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '货币类型 如英镑，美元，人民币',
    `currency_unit`     varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '货币单位 如¥，$，€，	￡',
    `standard_currency` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '标准货币 用户货币转换',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '报价列表历史记录'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '产品组装表'
  ROW_FORMAT = Dynamic;
...
(
    `id`                  bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`                  int(11)                                                      NULL DEFAULT NULL COMMENT '删除标识',
    `product_assembly_id` bigint(20)                                                   NULL DEFAULT NULL COMMENT '产品组装表Id',
    `part_id`             bigint(20)                                                   NULL DEFAULT NULL COMMENT '部件Id',
    `qty`                 int(11)                                                      NULL DEFAULT NULL COMMENT '部件数量',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '产品组装子表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_product_price
-- ----------------------------
DROP TABLE IF EXISTS `ope_product_price`;
CREATE TABLE `ope_product_price`
(
    `id`                 bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`                 int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `tenant_id`          bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '租户ID',
    `user_id`            bigint(20)                                                   NULL     DEFAULT 0 COMMENT '用户ID',
    `status`             int(11)                                                      NOT NULL DEFAULT 1 COMMENT '状态，0： Invalid失效:1：Effective有效:2：Cancel取消',
    `price`              decimal(10, 2)                                               NULL     DEFAULT NULL COMMENT '价格 浮点型价格',
    `price_type`         int(11)                                                      NULL     DEFAULT NULL COMMENT '价格类型，0：采购价，1：销售价',
    `currency_type`      int(11)                                                      NULL     DEFAULT NULL COMMENT '币种，0：人民币（¥），1：美元（$），2：欧元（€），3：英镑（￡）',
    `standard_currency`  int(11)                                                      NULL     DEFAULT 2 COMMENT '标准货币 用户货币转换，1：人民币（¥），2：美元（$），3：欧元（€），4：英镑（￡）',
    `exchange_rate`      varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '汇率 用于汇率转换',
    `product_id`         bigint(20)                                                   NULL     DEFAULT NULL COMMENT '部品主键(采购价时关联的是部件id，销售价时关联的是销售产品的id)',
    `product_price_type` int(11)                                                      NULL     DEFAULT NULL COMMENT '类型，1：采购部件，2：整车，3：组装，4：销售部件',
    `begin_date`         date                                                         NULL     DEFAULT NULL COMMENT '开始日期',
    `end_date`           date                                                         NULL     DEFAULT NULL COMMENT '结束日期',
    `revision`           int(11)                                                      NOT NULL COMMENT '乐观锁',
    `created_by`         bigint(20)                                                   NOT NULL COMMENT '创建人',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '产品价格表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_product_price_history
-- ----------------------------
DROP TABLE IF EXISTS `ope_product_price_history`;
CREATE TABLE `ope_product_price_history`
(
    `id`                 bigint(20)                                                   NOT NULL COMMENT '主键 主键',
    `dr`                 int(11)                                                      NOT NULL COMMENT '逻辑删除 逻辑删除',
    `tenant_id`          bigint(20)                                                   NOT NULL COMMENT '租户ID 租户ID',
    `user_id`            bigint(20)                                                   NULL DEFAULT NULL COMMENT '用户ID 用户ID',
    `product_price_id`   bigint(20)                                                   NULL DEFAULT NULL COMMENT '报价表主键 用于关联报价表',
    `price`              decimal(10, 2)                                               NULL DEFAULT NULL COMMENT '价格 浮点型价格',
    `price_type`         int(11)                                                      NULL DEFAULT NULL COMMENT '价格类型，0：采购价，1：销售价',
    `currency_type`      int(11)                                                      NULL DEFAULT NULL COMMENT '币种，0：人民币（¥），1：美元（$），2：欧元（€），3：英镑（￡）',
    `standard_currency`  int(11)                                                      NULL DEFAULT NULL COMMENT '标准货币 用户货币转换 0：人民币（¥），1：美元（$），2：欧元（€），3：英镑（￡）',
    `exchange_rate`      varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '汇率 用于汇率转换',
    `product_id`         bigint(20)                                                   NULL DEFAULT NULL COMMENT '部品主键(采购价时关联的是部件id，销售价时关联的是销售产品的id)',
    `product_price_type` int(11)                                                      NULL DEFAULT NULL COMMENT '类型，1：采购部件，2：整车，3：组装，4：销售部件',
    `revision`           int(11)                                                      NOT NULL COMMENT '乐观锁',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '产品价格历史记录表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '商品质检模板'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `pass_flag`              tinyint(1)                                                   NULL DEFAULT NULL COMMENT '通过标记',
    `upload_flag`            tinyint(1)                                                   NULL DEFAULT NULL COMMENT '是否允许上传图片',
    `results_sequence`       int(11)                                                      NULL DEFAULT NULL COMMENT '质检结果集优先级',
    `revision`               int(11)                                                      NOT NULL COMMENT '乐观锁',
    `created_by`             bigint(20)                                                   NOT NULL COMMENT '创建人',
    `created_time`           datetime(0)                                                  NOT NULL COMMENT '创建时间',
    `updated_by`             bigint(20)                                                   NOT NULL COMMENT '更新人',
...
-- ----------------------------
-- Table structure for ope_production_combin_bom
-- ----------------------------
DROP TABLE IF EXISTS `ope_production_combin_bom`;
CREATE TABLE `ope_production_combin_bom`
(
    `id`                  bigint(20)                                                   NOT NULL COMMENT '主键id',
    `dr`                  int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `tenant_id`           bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '租户ID',
    `dept_id`             bigint(20)                                                   NULL     DEFAULT NULL COMMENT '部门id（做数据权限用）',
    `version_identificat` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '版本标识',
    `bom_no`              varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT 'bom编号',
    `procurement_cycle`   int(11)                                                      NULL     DEFAULT NULL COMMENT '采购周期',
    `effective_date`      date                                                         NULL     DEFAULT NULL COMMENT '激活时间',
    `group_id`            bigint(20)                                                   NULL     DEFAULT NULL COMMENT '分组的id',
    `color_id`            bigint(20)                                                   NULL     DEFAULT NULL COMMENT '颜色的id',
    `disable`             int(2) UNSIGNED ZEROFILL                                     NULL     DEFAULT 00 COMMENT '是否禁用，0：否，1：是',
    `bom_status`          int(11)                                                      NULL     DEFAULT 1 COMMENT '状态，1：未激活，2：已激活，2：已失效',
    `announ_user_id`      bigint(20)                                                   NULL     DEFAULT NULL COMMENT '发布人id',
    `op_announ_user_id`   bigint(20)                                                   NULL     DEFAULT NULL COMMENT '操作发布人id',
    `versoin`             varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '版本',
    `parts_qty`           int(11)                                                      NULL     DEFAULT NULL COMMENT '部件数量',
    `cn_name`             varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '中文名称',
    `en_name`             varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '名称',
    `fr_name`             varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '法文名称',
    `created_by`          bigint(20)                                                   NOT NULL COMMENT '创建人',
    `created_time`        datetime(3)                                                  NOT NULL COMMENT '创建时间',
    `updated_by`          bigint(20)                                                   NOT NULL COMMENT '更新人',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '组装bom表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_production_combin_bom_draft
-- ----------------------------
DROP TABLE IF EXISTS `ope_production_combin_bom_draft`;
CREATE TABLE `ope_production_combin_bom_draft`
(
    `id`                bigint(20)                                                   NOT NULL COMMENT '主键id',
    `dr`                int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `tenant_id`         bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '租户ID',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '组装bom的草稿表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_production_parts
-- ----------------------------
DROP TABLE IF EXISTS `ope_production_parts`;
CREATE TABLE `ope_production_parts`
(
    `id`                    bigint(20)                                                    NOT NULL COMMENT '主键id',
    `dr`                    int(11)                                                       NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `tenant_id`             bigint(20)                                                    NOT NULL DEFAULT 0 COMMENT '租户ID',
    `dept_id`               bigint(20)                                                    NULL     DEFAULT NULL COMMENT '部门id（做数据权限用）',
    `parts_no`              varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '部件编号',
    `parts_type`            int(11)                                                       NULL     DEFAULT NULL COMMENT '部件类型，1：Parts，2：Accessory，3：Battery，4：Scooter，5：Combination',
    `parts_sec`             bigint(20)                                                    NULL     DEFAULT NULL COMMENT '部件区域编码id',
    `disable`               int(11)                                                       NULL     DEFAULT 0 COMMENT '是否禁用，0：否，1：是',
    `sn_class`              int(11)                                                       NULL     DEFAULT NULL COMMENT '是否可采购，0：否，1：是',
    `id_calss`              int(11)                                                       NULL     DEFAULT NULL COMMENT '是否有序列号，0：否，1：是',
    `parts_is_assembly`     int(11)                                                       NULL     DEFAULT NULL COMMENT '是否是组装件，0：否，1：是',
    `parts_is_for_assembly` int(11)                                                       NULL     DEFAULT NULL COMMENT '是否可用于组装件，0：否，1：是',
    `parts_qty`             int(11)                                                       NULL     DEFAULT NULL COMMENT '部品数量',
    ...
    `main_drawing`          varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '母图纸',
    `ecn_number`            varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci        NULL     DEFAULT NULL COMMENT '设变号',
    `item`                  varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci        NULL     DEFAULT NULL COMMENT '品目',
    `sell_calss`            varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '销售分区',
    `drawing_size`          varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci        NULL     DEFAULT NULL COMMENT '图纸尺寸',
    `weight`                double(10, 4)                                                 NULL     DEFAULT NULL COMMENT '重量',
    `supplier_id_2`         bigint(20)                                                    NULL     DEFAULT NULL COMMENT '供应商2',
    `rate_typ`              varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '依存度区分',
    `created_by`            bigint(20)                                                    NOT NULL COMMENT '创建人',
    `created_time`          datetime(3)                                                   NOT NULL COMMENT '创建时间',
    `updated_by`            bigint(20)                                                    NOT NULL COMMENT '更新人',
    `updated_time`          datetime(3)                                                   NOT NULL COMMENT '更新时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '部件表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_production_parts_draft
-- ----------------------------
DROP TABLE IF EXISTS `ope_production_parts_draft`;
CREATE TABLE `ope_production_parts_draft`
(
    `id`                    bigint(20)                                                    NOT NULL COMMENT '主键id',
    `dr`                    int(11)                                                       NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `tenant_id`             bigint(20)                                                    NOT NULL DEFAULT 0 COMMENT '租户ID',
    ...
    `supplier_id`           bigint(20)                                                    NULL     DEFAULT NULL COMMENT '供应商id',
    `procurement_cycle`     int(11)                                                       NULL     DEFAULT NULL COMMENT '采购周期',
    `perfect_flag`          tinyint(1)                                                    NULL     DEFAULT 0 COMMENT '是否信息完善（只有信息完善了才能发布）',
    `dwg`                   varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '图纸',
    `remark`                varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '备注',
    `cn_name`               varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '中文名称',
    `en_name`               varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '英文名称',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '部件的草稿表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_production_parts_relation
-- ----------------------------
DROP TABLE IF EXISTS `ope_production_parts_relation`;
CREATE TABLE `ope_production_parts_relation`
(
    `id`                bigint(20)                                                   NOT NULL COMMENT '主键id',
    `dr`                int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `production_id`     bigint(20)                                                   NULL     DEFAULT NULL COMMENT '关联的对象id（整车的草稿、bom，组装的草稿、bom）',
    `production_type`   int(11)                                                      NULL     DEFAULT NULL COMMENT '关联的对象类型，1：整车草稿，2：整车bom，3：组装草稿，4：组装bom',
    `parts_id`          bigint(20)                                                   NULL     DEFAULT NULL COMMENT '部件id',
    `parts_no`          varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '部件编号',
    `parts_sec`         bigint(20)                                                   NULL     DEFAULT NULL COMMENT '部件区域编码id',
    `procurement_cycle` int(11)                                                      NULL     DEFAULT NULL COMMENT '采购周期',
    `parts_qty`         int(11)                                                      NULL     DEFAULT NULL COMMENT '部品数量',
    `cn_name`           varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '中文名称',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '部件关系表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_production_quality_tempate
-- ----------------------------
DROP TABLE IF EXISTS `ope_production_quality_tempate`;
CREATE TABLE `ope_production_quality_tempate`
(
    `id`                    bigint(20)                                                    NOT NULL COMMENT '主键',
    `dr`                    int(11)                                                       NOT NULL COMMENT '逻辑删除',
    `production_id`         bigint(20)                                                    NULL DEFAULT NULL COMMENT '关联产品的Id（部件草稿，部件，整车草稿，整车，组装草稿，组装件）',
    `import_excel_batch_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '导入批次号',
    `source_type`           int(11)                                                       NULL DEFAULT NULL COMMENT '来源方式,(0：手动新增，1：导入)',
    `production_type`       int(11)                                                       NULL DEFAULT NULL COMMENT '关联类型,(0：部件草稿，1：部件，2：整车草稿，3：整车，4：组装草稿，5：组装件)',
    `qc_item_name`          varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '质检项名称',
    `revision`              int(11)                                                       NOT NULL COMMENT '乐观锁',
    `created_by`            bigint(20)                                                    NOT NULL COMMENT '创建人',
    `created_time`          datetime(3)                                                   NOT NULL COMMENT '创建时间',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '产品质检模板表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_production_quality_tempate_b
-- ----------------------------
DROP TABLE IF EXISTS `ope_production_quality_tempate_b`;
CREATE TABLE `ope_production_quality_tempate_b`
(
    `id`                         bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`                         int(11)                                                      NOT NULL COMMENT '逻辑删除',
    `product_quality_tempate_id` bigint(20)                                                   NULL DEFAULT NULL COMMENT '质检项Id',
    `qc_result`                  varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '质检结果',
    `pass_flag`                  tinyint(1)                                                   NULL DEFAULT NULL COMMENT '通过标记',
    `upload_flag`                tinyint(1)                                                   NULL DEFAULT NULL COMMENT '是否允许上传图片',
    `results_sequence`           int(11)                                                      NULL DEFAULT NULL COMMENT '质检结果集优先级',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '产品质检模板子表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_production_scooter_bom
-- ----------------------------
DROP TABLE IF EXISTS `ope_production_scooter_bom`;
CREATE TABLE `ope_production_scooter_bom`
(
    `id`                  bigint(20)                                                   NOT NULL COMMENT '主键id',
    `dr`                  int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `tenant_id`           bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '租户ID',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '整车bom表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_production_scooter_bom_draft
-- ----------------------------
DROP TABLE IF EXISTS `ope_production_scooter_bom_draft`;
CREATE TABLE `ope_production_scooter_bom_draft`
(
    `id`                bigint(20)                                                   NOT NULL COMMENT '主键id',
    `dr`                int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `tenant_id`         bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '租户ID',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '整车草稿表'
  ROW_FORMAT = Dynamic;
...
(
    `id`                 bigint(20)                                                    NOT NULL COMMENT '主键 主键',
    `dr`                 int(11)                                                       NULL     DEFAULT NULL COMMENT '逻辑删除标识 逻辑删除标识',
    `user_id`            bigint(20)                                                    NULL     DEFAULT NULL COMMENT '租户Id',
    `tenant_id`          bigint(20)                                                    NULL     DEFAULT NULL COMMENT '租户Id',
    ...
    `factory_id`         bigint(20)                                                    NULL     DEFAULT NULL COMMENT '工厂主键 代工厂Id',
    `factory_annex`      varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '工厂组装附件',
    `total_price`        decimal(10, 2)                                                NULL     DEFAULT NULL COMMENT '总金额 总金额',
    `total_qty`          int(11)                                                       NULL     DEFAULT NULL COMMENT '总数量 总数量',
    `lave_wait_qc_total` int(11)                                                       NULL     DEFAULT NULL COMMENT '待质检总数',
    `in_wait_wh_total`   int(11)                                                       NULL     DEFAULT NULL COMMENT '待入库总数',
    `revision`           int(11)                                                       NOT NULL DEFAULT 0 COMMENT '乐观锁',
    `created_by`         bigint(20)                                                    NULL     DEFAULT 0 COMMENT '创建人',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '采购订单'
  ROW_FORMAT = Dynamic;
...
(
    `id`               bigint(20)                                                    NOT NULL COMMENT '主键',
    `dr`               int(11)                                                       NULL     DEFAULT NULL COMMENT '逻辑删除表示',
    `tenant_id`        bigint(20)                                                    NULL     DEFAULT NULL COMMENT '租户Id',
    `user_id`          bigint(20)                                                    NULL     DEFAULT NULL COMMENT '租户Id',
    `purchas_id`       bigint(20)                                                    NULL     DEFAULT NULL COMMENT '采购订单Id',
    `part_id`          bigint(20)                                                    NULL     DEFAULT NULL COMMENT '部品Id',
    `supplier_id`      bigint(20)                                                    NULL     DEFAULT NULL COMMENT '供应商Id',
    `supplier_annex`   varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '供应商附件',
    ...
    `lave_wait_qc_qty` int(11)                                                       NULL     DEFAULT NULL COMMENT '待质检数',
    `in_wait_wh_qty`   int(11)                                                       NULL     DEFAULT NULL COMMENT '待入库数量',
    `created_by`       bigint(20)                                                    NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_time`     datetime(0)                                                   NULL     DEFAULT NULL COMMENT '创建时间',
    `updated_by`       bigint(20)                                                    NULL     DEFAULT 0 COMMENT '更新人',
    `updated_time`     datetime(0)                                                   NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '采购单条目'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `tenant_id`               bigint(20)                                                 NULL     DEFAULT NULL COMMENT '租户Id',
    `user_id`                 bigint(20)                                                 NULL     DEFAULT NULL COMMENT 'userId',
    `purchas_b_id`            bigint(20)                                                 NULL     DEFAULT NULL COMMENT '采购单条目Id',
    `parts_id`                bigint(20)                                                 NULL     DEFAULT NULL COMMENT '部品Id',
    `quality_inspector_id`    bigint(20)                                                 NULL     DEFAULT NULL COMMENT '质检人Id',
    `batch_no`                varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL     DEFAULT NULL COMMENT '质检批次号',
    `status`                  varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci     NULL     DEFAULT NULL COMMENT '质检状态',
    `total_quality_inspected` int(11)                                                    NULL     DEFAULT NULL COMMENT '需要质检总数',
...
(
    `id`                     bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`                     int(11)                                                      NULL     DEFAULT NULL COMMENT '删除标志',
    `purchas_b_id`           bigint(20)                                                   NULL     DEFAULT NULL COMMENT '采购单子表Id',
    `part_id`                bigint(20)                                                   NULL     DEFAULT NULL COMMENT '部品Id',
    `purchas_b_qc_id`        bigint(20)                                                   NULL     DEFAULT 0 COMMENT '质检结果Id',
    `purchas_b_lot_trace_id` bigint(20)                                                   NULL     DEFAULT NULL COMMENT '质检批次记录Id',
    `batch_no`               varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '批次号',
    `serial_num`             varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '部品序列号',
    `qc_batch_total`         int(11)                                                      NULL     DEFAULT NULL COMMENT '批量质检数量 和质检方式连用',
    `qc_result`              varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '质检结果',
    `revision`               int(11)                                                      NOT NULL DEFAULT 0 COMMENT '乐观锁',
    `created_by`             bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_time`           datetime(0)                                                  NULL     DEFAULT NULL COMMENT '创建时间',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '部件质检条目'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `tenant_id`               bigint(20)                                                 NULL     DEFAULT NULL COMMENT '租户Id',
    `user_id`                 bigint(20)                                                 NULL     DEFAULT NULL COMMENT 'userId',
    `purchas_id`              bigint(20)                                                 NULL     DEFAULT NULL COMMENT '采购单号',
    `quality_inspector_id`    bigint(20)                                                 NULL     DEFAULT NULL COMMENT '质检人Id',
    `batch_no`                varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL     DEFAULT NULL COMMENT '质检批次号',
    `total_quality_inspected` int(11)                                                    NULL     DEFAULT NULL COMMENT '需要质检总数',
    `pass_count`              int(11)                                                    NULL     DEFAULT NULL COMMENT '质检通过数量',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '采购单批次质检记录'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '销售订单支付表 分期时表明是第几期支付的'
  ROW_FORMAT = Dynamic;
...
(
    `id`           bigint(20)                                                 NOT NULL COMMENT '主键',
    `dr`           int(11)                                                    NULL     DEFAULT NULL COMMENT '删除表示',
    `tenant_id`    bigint(20)                                                 NULL     DEFAULT NULL COMMENT '租户Id',
    `user_id`      bigint(20)                                                 NULL     DEFAULT NULL COMMENT '租户Id',
    `purchas_id`   bigint(20)                                                 NULL     DEFAULT NULL COMMENT '采购订单id',
    `product_id`   bigint(20)                                                 NULL     DEFAULT NULL COMMENT '产品Id',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '采购订单产品表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `dr`                      int(11)                                                       NULL DEFAULT NULL COMMENT '删除标识',
    `part_id`                 bigint(20)                                                    NULL DEFAULT NULL COMMENT '部件Id',
    `purchas_id`              bigint(20)                                                    NULL DEFAULT NULL COMMENT '采购单id',
    `purchas_b_qc_id`         bigint(20)                                                    NULL DEFAULT NULL COMMENT '采购单子表Id',
    `part_qc_template_id`     bigint(20)                                                    NULL DEFAULT NULL COMMENT '质检模板Id',
    `part_qc_template_name`   varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '模板质检项名称',
    `part_qc_template_b_id`   bigint(20)                                                    NULL DEFAULT NULL COMMENT '质检结果Id',
    `part_qc_template_b_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '模板质检结果名称',
    `purchas_b_qc_item_id`    bigint(20)                                                    NULL DEFAULT NULL COMMENT '质检条目Id',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '采购单质检记录'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '采购订单节点表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `user_id`           bigint(20)                                                    NOT NULL COMMENT '用户ID',
    `status`            varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '状态 状态',
    `parts_product_id`  bigint(20)                                                    NULL DEFAULT NULL COMMENT '产品Id',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '区域报价表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `tenant_id`               bigint(20)                                                    NOT NULL COMMENT '租户ID',
    `user_id`                 bigint(20)                                                    NOT NULL COMMENT '用户ID',
    `regional_price_sheet_id` bigint(20)                                                    NULL DEFAULT NULL COMMENT '区域报价主键 关联区域报价表',
    `parts_product_id`        bigint(20)                                                    NULL DEFAULT NULL COMMENT '产品ID',
    `price_type`              varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '价格类型，1.销售价，2采购价，3其他价格',
    `sales_price`             decimal(10, 2)                                                NULL DEFAULT NULL COMMENT '销售价格 浮点型价格',
    `currency_type`           varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '货币类型 如英镑，美元，人民币',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '区域报价表历史记录表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_sale_area
-- ----------------------------
...
(
    `id`          bigint(20)                                              NOT NULL COMMENT '主键id',
    `dr`          int(11)                                                 NOT NULL DEFAULT 0 COMMENT '逻辑删除标识',
    `p_id`        bigint(20)                                              NULL     DEFAULT NULL COMMENT '父级区域id',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '销售区域表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_sale_combin
-- ----------------------------
DROP TABLE IF EXISTS `ope_sale_combin`;
CREATE TABLE `ope_sale_combin`
(
    `id`                       bigint(20)                                                    NOT NULL COMMENT '主键',
    `dr`                       int(11)                                                       NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `dept_id`                  bigint(20)                                                    NULL     DEFAULT NULL COMMENT '所属部门id',
    `product_name`             varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '产品名称',
    `product_code`             varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci        NULL     DEFAULT NULL COMMENT '产品编码',
    `combin_name`              varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '组装件名称(英文名称)',
    `production_combin_bom_id` bigint(20)                                                    NULL     DEFAULT NULL COMMENT '组装件id',
    `sale_stutas`              int(2)                                                        NULL     DEFAULT 0 COMMENT '销售状态，0：不可销售，1：可销售',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '销售组装件表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_sale_parts
-- ----------------------------
DROP TABLE IF EXISTS `ope_sale_parts`;
CREATE TABLE `ope_sale_parts`
(
    `id`           bigint(20)                                                    NOT NULL COMMENT '主键',
    `dr`           int(11)                                                       NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `dept_id`      bigint(20)                                                    NULL     DEFAULT NULL COMMENT '所属部门id',
    `product_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '产品名称',
    `product_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci        NULL     DEFAULT NULL COMMENT '产品编码',
    `parts_name`   varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '部件名称(英文名称)',
    `parts_id`     bigint(20)                                                    NULL     DEFAULT NULL COMMENT '部件id',
    `sale_stutas`  int(2)                                                        NULL     DEFAULT 0 COMMENT '销售状态，0：不可销售，1：可销售',
    `remark`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '备注',
    `created_by`   bigint(20)                                                    NOT NULL COMMENT '创建人',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '销售部件表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_sale_scooter
-- ----------------------------
DROP TABLE IF EXISTS `ope_sale_scooter`;
CREATE TABLE `ope_sale_scooter`
(
    `id`            bigint(20)                                                    NOT NULL COMMENT '主键',
    `dr`            int(11)                                                       NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `dept_id`       bigint(20)                                                    NULL     DEFAULT NULL COMMENT '所属部门id',
    `product_name`  varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '产品名称',
    `product_code`  varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci        NULL     DEFAULT NULL COMMENT '产品编码',
    `specificat_id` bigint(20)                                                    NULL     DEFAULT NULL COMMENT '车辆所属规格id',
    `group_id`      bigint(20)                                                    NULL     DEFAULT NULL COMMENT '车辆所属分组id',
    `color_id`      bigint(20)                                                    NULL     DEFAULT NULL COMMENT '车辆所属颜色id',
    `sale_stutas`   int(2)                                                        NULL     DEFAULT 0 COMMENT '销售状态，0：不可销售，1：可销售',
    `remark`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '备注',
    `created_by`    bigint(20)                                                    NOT NULL COMMENT '创建人',
    `created_time`  datetime(3)                                                   NOT NULL COMMENT '创建时间',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '销售车辆表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_specificat_def
-- ----------------------------
DROP TABLE IF EXISTS `ope_specificat_def`;
CREATE TABLE `ope_specificat_def`
(
    `id`            bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`            int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `specificat_id` bigint(20)                                                   NULL     DEFAULT NULL COMMENT '所属规格id',
    `def_name`      varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '自定义名称',
    `def_value`     double(13, 3)                                                NULL     DEFAULT NULL COMMENT '自定义的值',
    `created_by`    bigint(20)                                                   NOT NULL COMMENT '创建人',
    `created_time`  datetime(3)                                                  NOT NULL COMMENT '创建时间',
    `updated_by`    bigint(20)                                                   NOT NULL COMMENT '更新人',
    `updated_time`  datetime(3)                                                  NOT NULL COMMENT '更新时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '规格自定义项表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_specificat_group
-- ----------------------------
DROP TABLE IF EXISTS `ope_specificat_group`;
CREATE TABLE `ope_specificat_group`
(
    `id`              bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`              int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `group_name`      varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '分组名称',
    `production_type` int(11)                                                      NULL     DEFAULT NULL COMMENT '产品类型，1：整车，2：组装',
    `remark`          varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci      NULL     DEFAULT NULL COMMENT '备注',
    `created_by`      bigint(20)                                                   NOT NULL COMMENT '创建人',
    `created_time`    datetime(3)                                                  NOT NULL COMMENT '创建时间',
    `updated_by`      bigint(20)                                                   NOT NULL COMMENT '更新人',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '规格分组表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_specificat_type
-- ----------------------------
DROP TABLE IF EXISTS `ope_specificat_type`;
CREATE TABLE `ope_specificat_type`
(
    `id`              bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`              int(11)                                                      NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `specificat_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '规格名称',
    `specificat_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '规格类型编码',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '规格类型表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `worn_total`            int(11)                                                      NULL DEFAULT NULL COMMENT '破损总数',
    `lock_total`            int(11)                                                      NULL DEFAULT NULL COMMENT '锁定库存',
    `wait_product_total`    int(11)                                                      NULL DEFAULT NULL COMMENT '待生产',
    `wait_stored_total`     int(11)                                                      NULL DEFAULT NULL COMMENT '待入库',
    `materiel_product_id`   bigint(20)                                                   NULL DEFAULT NULL COMMENT '所属物料产品Id',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '库存总表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `tenant_id`         bigint(20)                                                   NULL DEFAULT NULL COMMENT '租户id',
    `stock_id`          bigint(20)                                                   NULL DEFAULT NULL COMMENT '库存id',
    `part_id`           bigint(20)                                                   NULL DEFAULT NULL COMMENT '物料ID',
    ...
    `principal_id`      bigint(20)                                                   NULL DEFAULT NULL COMMENT '入库负责人Id',
    `in__wh_qty`        int(11)                                                      NULL DEFAULT NULL COMMENT '入库数量',
    `available_qty`     int(11)                                                      NULL DEFAULT NULL COMMENT '可用数量',
    `in_stock_time`     datetime(0)                                                  NULL DEFAULT NULL COMMENT '入库时间',
    `out_stock_time`    datetime(0)                                                  NULL DEFAULT NULL COMMENT '出库时间',
    `out_principal_id`  bigint(20)                                                   NULL DEFAULT NULL COMMENT '出库负责人',
    `revision`          int(11)                                                      NOT NULL COMMENT '乐观锁',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '生产原料库存'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `in_stock_time`     datetime(0)                                                  NULL DEFAULT NULL COMMENT '入库时间',
    `out_stock_bill_id` bigint(20)                                                   NULL DEFAULT NULL COMMENT '出库单Id',
    `bind_order_id`     bigint(20)                                                   NULL DEFAULT NULL COMMENT '绑定的出库单Id',
    `source_type`       varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '单据来源',
    `out_principal_id`  bigint(20)                                                   NULL DEFAULT NULL COMMENT '出库负责人',
    `out_stock_time`    datetime(0)                                                  NULL DEFAULT NULL COMMENT '出库时间',
    `revision`          int(11)                                                      NOT NULL COMMENT '乐观锁',
    `created_by`        bigint(20)                                                   NULL DEFAULT 0 COMMENT '创建人',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '生产成品库'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '采购库存'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '采购商'
  ROW_FORMAT = Dynamic;
...
(
    `id`           bigint(20)                                              NOT NULL COMMENT 'ID',
    `dr`           int(11)                                                 NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `supplier_id`  bigint(20)                                              NOT NULL COMMENT '采购商ID',
    `tenant_id`    bigint(20)                                              NULL     DEFAULT NULL COMMENT '租户ID',
    `user_id`      bigint(20)                                              NULL     DEFAULT NULL COMMENT '用户ID',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '采购商操作根据表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `dr`           int(11)                                                       NOT NULL DEFAULT 0 COMMENT '逻辑删除',
    `p_id`         bigint(20)                                                    NULL     DEFAULT NULL COMMENT '父级部门id',
    `tenant_id`    bigint(20)                                                    NULL     DEFAULT NULL COMMENT '租户id',
    `principal`    bigint(20)                                                    NULL     DEFAULT 0 COMMENT '负责人',
    ...
    `dept_status`  int(11)                                                       NULL     DEFAULT 1 COMMENT '部门状态 1：正常，2：禁用',
...
-- ----------------------------
-- Table structure for ope_sys_log
-- ----------------------------
DROP TABLE IF EXISTS `ope_sys_log`;
CREATE TABLE `ope_sys_log`
(
    `id`                bigint(20)                                                   NOT NULL COMMENT '主键',
    `dr`                int(11)                                                      NULL     DEFAULT 0 COMMENT '逻辑删除标识 0：正常，1：删除',
    `op_modul`          varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci      NULL     DEFAULT NULL COMMENT '操作模块',
    `op_user_name`      varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci      NULL     DEFAULT NULL COMMENT '操作人名称',
    `op_user_code`      varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci      NULL     DEFAULT NULL COMMENT '操作人编码',
    `op_user_dept_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci      NULL     DEFAULT NULL COMMENT '操作人部门',
    `op_method`         varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci      NULL     DEFAULT NULL COMMENT '操作方法',
    `login_ip`          varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci      NULL     DEFAULT NULL COMMENT '登陆的IP',
    ...
    `request_type`      varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '请求方式',
    `response_param`    json                                                         NULL COMMENT '返回参数',
    `exp_msg`           varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci     NULL     DEFAULT NULL COMMENT '异常信息',
    `log_type`          int(11)                                                      NULL     DEFAULT 1 COMMENT '日志类型，1:登陆，2：操作',
    `if_success`        int(11)                                                      NULL     DEFAULT 0 COMMENT '请求是否成功，1：是，0：否',
    `time_consum`       bigint(20)                                                   NULL     DEFAULT NULL COMMENT '请求时长（毫秒）',
    `created_by`        bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_time`      datetime(3)                                                  NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
    `updated_by`        bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '更新人',
    `updated_time`      datetime(3)                                                  NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
    ...
    `def2`              varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '冗余字段',
    `def3`              varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '冗余字段',
    `def4`              decimal(10, 2)                                               NULL     DEFAULT NULL COMMENT '冗余字段',
    `def5`              varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '冗余字段',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8
...
(
    ...
    `type`         char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci      NULL     DEFAULT '0' COMMENT '菜单类型：1:目录，2:菜单，3：按钮，4:开放API   ',
    `if_to_link`   char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci      NULL     DEFAULT NULL COMMENT '是否外链。0：否，1：是',
    `menu_status`  int(10) UNSIGNED                                              NULL     DEFAULT 1 COMMENT '状态 1：正常，2：禁用',
    `icon`         varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '图表',
    `level`        int(11)                                                       NULL     DEFAULT 0 COMMENT '等级,1:目录，2:菜单，3：按钮',
    `sort`         int(11)                                                       NULL     DEFAULT 1 COMMENT '菜单权重',
  ...
  AUTO_INCREMENT = 1010631
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '菜单权限表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_sys_position
-- ----------------------------
...
(
    ...
    `position_code`   varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci       NULL     DEFAULT NULL COMMENT '岗位编码',
    `dept_id`         bigint(20)                                                   NULL     DEFAULT NULL COMMENT '所属部门id',
    `sort`            int(11)                                                      NULL     DEFAULT NULL COMMENT '岗位排序',
    `position_status` int(11)                                                      NULL     DEFAULT 1 COMMENT '岗位状态  1：正常，2：禁用',
    `remark`          varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci      NULL     DEFAULT NULL COMMENT '备注',
    `created_by`      bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_time`    datetime(3)                                                  NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
    `updated_by`      bigint(20)                                                   NOT NULL DEFAULT 0 COMMENT '更新人',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '岗位表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `dr`          int(11)                                                       NOT NULL DEFAULT 0 COMMENT '逻辑删除标识',
    `tenant_id`   bigint(20)                                                    NULL     DEFAULT NULL COMMENT '租户id',
    `position_id` bigint(20)                                                    NULL     DEFAULT NULL COMMENT '所属岗位id',
    ...
    `role_status` int(11)                                                       NULL     DEFAULT 1 COMMENT '角色状态  1：正常，2：禁用',
    `role_desc`   varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '角色描述',
    `sort`        int(11)                                                       NULL     DEFAULT NULL COMMENT '排序',
    `sale_area`   int(11)                                                       NULL     DEFAULT 0 COMMENT '是否开启销售区域功能 0：否，1：是',
    `created_by`  bigint(20)                                                    NOT NULL COMMENT '创建人',
  ...
  AUTO_INCREMENT = 1012600
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '系统角色表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ope_sys_role_data
-- ----------------------------
...
(
    ...
    `data_type` int(11)    NULL DEFAULT NULL COMMENT '类型，1:全部,2:本人,3:本部门,4:本部门及下属部门'
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '角色数据权限表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '用户销售区域关系表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `dr`                   int(11)                                                  NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `tenant_id`            bigint(20)                                               NULL     DEFAULT NULL COMMENT '租户id',
    `status`               int(11)                                                  NULL     DEFAULT NULL COMMENT '员工状态 1：正常，2：禁用',
    `dept_id`              bigint(20)                                               NULL     DEFAULT NULL COMMENT '所属部门id',
    `position_id`          bigint(20)                                               NULL     DEFAULT NULL COMMENT '所属岗位id',
    `role_id`              bigint(20)                                               NULL     DEFAULT NULL COMMENT '所属角色id',
    `country_code`         varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '国家编码如+86',
    `telephone`            varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '联系电话',
    `email`                varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '邮箱账号',
    `entry_date`           date                                                     NULL     DEFAULT NULL COMMENT '入职日期',
    `country_name`         varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '国籍',
    `address_1`            varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '地址1',
    `address_2`            varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '地址2',
    `birthday`             datetime(0)                                              NULL     DEFAULT NULL COMMENT '生日',
    `certificate_type`     int(11)                                                  NULL     DEFAULT 1 COMMENT '证件类型 1：身份证，2：驾驶证，3：护照',
    `certificat_picture_1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '图片1（身份证正面或者驾驶证或者护照）',
    `certificat_picture_2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '图片2（身份证反面）',
    `open_account`         char(1) CHARACTER SET utf8 COLLATE utf8_bin              NULL     DEFAULT '0' COMMENT '是否开通账号 0：否，1：是',
    `remark`               varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '备注',
    `employee_picture`     varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '员工头像',
    `first_name`           varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '员工姓',
    `last_name`            varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '员工名',
    `full_name`            varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL     DEFAULT NULL COMMENT '员工全名',
    `code`                 varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci   NULL     DEFAULT NULL COMMENT '员工编码',
    `gender`               int(11)                                                  NULL     DEFAULT 1 COMMENT '性别 1：男，2：女',
    `sys_user_id`          bigint(20)                                               NOT NULL DEFAULT 0 COMMENT '用户ID',
    `if_safe_code`         int(11)                                                  NULL     DEFAULT NULL COMMENT '是否开启安全码（0：否，1：是）',
    `safe_code`            varchar(2500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '安全码',
    `created_by`           bigint(20)                                               NOT NULL DEFAULT 0 COMMENT '创建人',
    `created_time`         datetime(0)                                              NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
    `updated_by`           bigint(20)                                               NOT NULL DEFAULT 0 COMMENT '更新人',
    `updated_time`         datetime(0)                                              NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '用户员工表'
  ROW_FORMAT = Dynamic;
...
(
    `id`                         bigint(20)                                               NOT NULL COMMENT 'ID',
    `dr`                         int(11)                                                  NULL     DEFAULT 0 COMMENT '逻辑删除标识 0正常 1删除',
    `repair_shop_Id`             bigint(20)                                               NOT NULL DEFAULT 0 COMMENT '维修店ID',
    `sys_user_id`                bigint(20)                                               NOT NULL DEFAULT 0 COMMENT '用户ID',
