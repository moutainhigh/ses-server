...
(
    ...
    `user_id`      bigint(11)                                             NULL     DEFAULT NULL COMMENT 'userid',
    `biz_type`     varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT '发票业务类型',
    `biz_id`       bigint(20)                                             NULL     DEFAULT NULL COMMENT '发票产生的的具体业务ID 、存放 scooteId',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '发票表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '罚款'
  ROW_FORMAT = Dynamic;
...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '租户节点表'
  ROW_FORMAT = Dynamic;
