...
@ApiModel(value = "com-redescooter-ses-service-mobile-b-dm-base-CorDriverRideStatDetail")
@Data
@TableName(value = "cor_driver_ride_stat_detail")
public class CorDriverRideStatDetail implements Serializable {
    /**
     * 主键
     */
