...
@ApiModel(value = "com-redescooter-ses-service-mobile-b-dm-base-CorExpressOrder")
@Data
...
public class CorExpressOrder implements Serializable {
     ...
     * 订单完成时间
     */
    @TableField(value = "delivered_time")
    ...
    public static final String COL_DELIVERED_TIME = "delivered_time";
