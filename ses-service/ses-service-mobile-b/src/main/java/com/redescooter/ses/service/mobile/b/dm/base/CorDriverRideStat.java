...
@ApiModel(value="com-redescooter-ses-service-mobile-b-dm-base-CorDriverRideStat")
@Data
@TableName(value = "cor_driver_ride_stat")
public class CorDriverRideStat implements Serializable {
    /**
     * 主键
     */
