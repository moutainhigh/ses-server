...
@ApiModel(value = "com-redescooter-ses-service-mobile-b-dm-base-CorScooterRideStatDetail")
@Data
@TableName(value = "cor_scooter_ride_stat_detail")
public class CorScooterRideStatDetail implements Serializable {
    /**
     * 主键
     */
