...
@ApiModel(value = "com-redescooter-ses-service-foundation-dm-base-PlaUserNode")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "pla_user_node")
public class PlaUserNode implements Serializable {
    /**
     * 主键
     */
