...
@ApiModel(value="com-redescooter-ses-service-mobile-c-dm-base-ConScooterRideStat")
@Data
@TableName(value = "con_scooter_ride_stat")
public class ConScooterRideStat implements Serializable {
    /**
     * 主键
     */
