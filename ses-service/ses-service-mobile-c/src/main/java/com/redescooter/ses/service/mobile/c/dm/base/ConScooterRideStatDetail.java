...
@ApiModel(value="com-redescooter-ses-service-mobile-c-dm-base-ConScooterRideStatDetail")
@Data
@TableName(value = "con_scooter_ride_stat_detail")
public class ConScooterRideStatDetail implements Serializable {
    /**
     * 主键
     */
    ...
    private Double co2HistoryTotal;
