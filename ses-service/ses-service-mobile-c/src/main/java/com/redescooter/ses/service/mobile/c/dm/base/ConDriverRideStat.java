...
@ApiModel(value="com-redescooter-ses-service-mobile-c-dm-base-ConDriverRideStat")
@Data
@TableName(value = "con_driver_ride_stat")
public class ConDriverRideStat implements Serializable {
    /**
     * 主键
     */
