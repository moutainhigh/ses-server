...
// List<OpeProductionScooterBom> productionScooterBomList = opeProductionScooterBomService.list(new
// LambdaQueryWrapper<OpeProductionScooterBom>().eq(OpeProductionScooterBom::getBomStatus,
