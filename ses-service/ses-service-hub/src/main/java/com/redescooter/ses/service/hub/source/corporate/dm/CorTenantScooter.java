...
@ApiModel(value = "com-redescooter-ses-service-hub-source-corporate-dm-CorTenantScooter")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
...
public class CorTenantScooter implements Serializable {
    ...
    public static CorTenantScooterBuilder builder() {
        return new CorTenantScooterBuilder();
    }
}