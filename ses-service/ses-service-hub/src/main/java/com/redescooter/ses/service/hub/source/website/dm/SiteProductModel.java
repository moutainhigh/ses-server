...
/**
    * 产品型号表
    */
@ApiModel(value="com-redescooter-ses-service-hub-source-website-dm-SiteProductModel")
@Data
...
public class SiteProductModel {
     ...
     * 产品种类主建
     */
    @TableField(value = "product_class_id")
     ...
     * 产品类型单项编码
     */
    @TableField(value = "product_model_code")
     ...
     * 产品类型单项名称
     */
    @TableField(value = "product_model_name")
    ...
    public static final String COL_PRODUCT_CLASS_ID = "product_class_id";

    public static final String COL_PRODUCT_MODEL_CODE = "product_model_code";

    public static final String COL_PRODUCT_MODEL_NAME = "product_model_name";
