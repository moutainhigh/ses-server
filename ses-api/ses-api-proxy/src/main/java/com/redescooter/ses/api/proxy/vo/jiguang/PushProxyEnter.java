package com.redescooter.ses.api.proxy.vo.jiguang;
...
/**
 * description: PushProxyEnter 极光推送
 * author: jerry.li
...
public class PushProxyEnter extends GeneralEnter {
    ...
    //设备类型  当前支持 Android, iOS, Windows Phone 三个平台的推送,没有为none.
