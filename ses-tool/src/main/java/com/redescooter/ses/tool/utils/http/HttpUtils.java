...
import  com.redescooter.ses.tool.utils.http.HttpRequestEntity.FileItem;
	...
	public static String downloadFile(String fileURL, String saveDir){
		...
		try {
	        ...
	        if (responseCode == HttpURLConnection.HTTP_OK) {
	        	...
	        	throw new BaseException(String.valueOf(responseCode), "下载失败");
	        }
		} catch (IOException e) {
			throw new BaseException(String.valueOf(500), "下载失败",e);
		}finally {
